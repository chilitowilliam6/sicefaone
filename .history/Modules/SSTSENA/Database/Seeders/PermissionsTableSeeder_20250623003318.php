...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       // Permiso para editar Personas Involucradas
        $permission = Permission::updateOrCreate(['slug' => 'sstsena.funcionario.people_involved.edit'], [
            'name' => 'Editar Personas Involucradas',
            'description' => 'Editar Personas Involucradas',
            'description_english' => 'Edit People Involved',
            'app_id' => $app->id
        ]);
        $permissions_admin[] = $permission->id; // Almacenar permiso para admin

        // Permiso para actualizar Personas Involucradas
        $permission = Permission::updateOrCreate(['slug' => 'sstsena.funcionario.people_involved.update'], [
        ...
        $permission = Permission::updateOrCreate(['slug' => 'sstsena.funcionario.people_involved.destroy'], [
        ...
        // Asignar permisos al rol de administrador (si es necesario)
        $adminRole = Role::where('name', 'admin')->first();
        if ($adminRole) {
            $adminRole->permissions()->sync($permissions_admin);
        }
    }
