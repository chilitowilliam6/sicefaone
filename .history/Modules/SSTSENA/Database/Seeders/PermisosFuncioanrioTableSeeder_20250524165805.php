...
class PermisosFuncioanrioTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Rutas para el create de Accidentes
        ...
        // Rutas para el edit de Accidentes
        ...
        // Rutas para el show de Accidentes
        $permission = Permission::updateOrCreate(['slug' => 'sstsena.funcionario.accidents.show'], [ // Registro o actualización de permiso
            'name' => 'Ver Accidentes',
            'description' => 'Ver Accidentes',
            'description_english' => 'View Accidents',
            'app_id' => $app->id
        ]);
        $permissions_funcionario[] = $permission->id; // Almacenar permiso para rol

        // Rutas para el destroy de Accidentes
        ...
        // Rutas para el store de Accidentes
        $permission = Permission::updateOrCreate(['slug' => 'sstsena.funcionario.accidents.store'], [ // Registro o actualización de permiso
            'name' => 'Registrar Accidentes',
            'description' => 'Registrar Accidentes',
            'description_english' => 'Register Accidents',
            'app_id' => $app->id
        ]);
        $permissions_funcionario[] = $permission->id; // Almacenar permiso para rol

        // Rutas para el update de Accidentes
