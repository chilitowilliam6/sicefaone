...
class PermisosFuncioanrioTableSeeder extends Seeder
{
    ...
    ['slug' => 'sstsena.funcionario.accidents.update'],
    [
        'name' => 'Actualizar Accidentes',
        'description' => 'Permite actualizar los registros de accidentes en el sistema',
        'description_english' => 'Update Accident Records',
        'app_id' => $app->id
    ]
);
