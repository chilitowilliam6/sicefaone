...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Rutas funcionario
         $permission = Permission::updateOrCreate(['slug' => 'sstsena.funcionario.pruebas'], [ // Registro o actualización de permiso
        ...
        $rol_admin = Role::where('slug', 'sstsena.admin')->first(); // Rol Administrador
         $rol_funcionario = Role::where('slug', 'sstsena.admin')->first(); // Rol Administrador
