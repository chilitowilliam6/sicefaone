...
class PermisosFuncioanrioTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission = Permission::updateOrCreate(['slug' => 'sstsena.funcionario.accidents.show'], [ // Registro o actualización de permiso
            'name' => 'Acceso a la vista principal de Accidentes',
            'description' => 'Acceso a la vista principal de Accidentes',
            'description_english' => 'Access to the main view of Accidents',
            'app_id' => $app->id
        ]);
