...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Array de slugs que el funcionario ya tiene
$funcionarioSlugs = [
    ...
    // Agrega aquí otros slugs que también quieras incluir
];

// Obtener permisos por esos slugs
$funcionarioPermissions = Permission::whereIn('slug', $funcionarioSlugs)->pluck('id')->toArray();

// Agregar al array del admin
