...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Rutas para el create de tipos de lesiones
           $permission = Permission::updateOrCreate(['slug' => 'sstsena.admin.injury_types.create'], [ // Registro o actualización de permiso
            'name' => 'mostrar formulario de tipos de lesiones',
            'description' => 'mostrar formulario de tipos de lesiones',
            'description' => 'vista principal de tipos de lesiones',
            'description_english' => 'Access to the Administrator Role',
            'app_id' => $app->id
        ]);
        ...
        // Rutas para el creat de tipos de lesiones
           $permission = Permission::updateOrCreate(['slug' => 'sstsena.admin.injury_types.create'], [ // Registro o actualización de permiso
            'name' => 'mostrar formulario de tipos de lesiones',
            'description' => 'mostrar formulario de tipos de lesiones',
            'description' => 'vista principal de tipos de lesiones',
