            ...
            Route::prefix('risk_types')->group(function(){
                ...
                Route::prefix('accidents')->group(function() {
                 ...
                 Route::prefix('TypePerson')->group(function() { 
                    Route::get('/', [AccidentController::class,"TypePerson"])->name('sstsena.funcionario.accidents.TypePerson');
                    Route::get('/{id}/edit', [AccidentController::class,"TypePersonEdit"])->name('sstsena.funcionario.accidents.TypePersonEdit');
                    Route::put('/{id}/update', [AccidentController::class,"TypePersonUpdate"])->name('sstsena.funcionario.accidents.TypePersonUpdate');
                    Route::get('/{id}/show', [AccidentController::class,"TypePersonShow"])->name('sstsena.funcionario.accidents.TypePersonShow');   
                });
            });
        });
    });
