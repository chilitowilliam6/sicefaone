...
Route::middleware(['lang'])->group(function () { // Middleware que permite la internacionalización
    ...
    Route::get('/events', [EventController::class, 'index'])->name('cefa.sstsena.events.index');
   ...
   Route::prefix('accidents/{accidentId}/responses')->name('cefa.accidents.responses.')->group(function () {
    ...
    Route::prefix('incidents/{incidentId}/responses')->name('cefa.sstsenaincidents.responses.')->group(function () {
    ...
    Route::prefix('emergencies/{emergencyId}/responses')->name('cefa.emergencies.responses.')->group(function () {
    ...
    Route::prefix('unsafe_acts/{unsafeActId}/responses')->name('cefa.unsafe_acts.responses.')->group(function () {
