...
Route::middleware(['lang'])->group(function () { //Middleware que permite la internacionalizacion
    ...
    Route::prefix('SSTSENA')->group(function() {
        ...
        Route::prefix('injuy_types')->group(function() {
          ...
          Route::prefix('risk_types')->group(function(){
            Route::get('/', [InjuryTypeController::class,"index"])->name('sstsena.admin.risk_types.index');
            Route::get('/create', [InjuryTypeController::class,"create"])->name('sstsena.admin.risk_types.create');
            Route::post('/store', [InjuryTypeController::class,"store"])->name('sstsena.admin.risk_types.store'); 
            Route::get('/{id}/edit', [InjuryTypeController::class,"edit"])->name('sstsena.admin.risk_types.edit');
            Route::put('/{id}/update', [InjuryTypeController::class,"update"])->name('sstsena.admin.risk_types.update');
            Route::delete('/{id}/destroy', [InjuryTypeController::class,"destroy"])->name('sstsena.admin.risk_types.destroy');
          });
        });
    });
});
