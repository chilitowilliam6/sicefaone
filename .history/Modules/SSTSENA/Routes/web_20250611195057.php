...
Route::middleware(['lang'])->group(function () { // Middleware que permite la internacionalización
   ...
   Route::prefix('accidents/{accidentId}/responses')->name('cefa.accidents.responses.')->group(function () {
        Route::get('/', [EventResponseController::class, 'cefa.indexAccidents'])->name('index');
        Route::get('/create', [EventResponseController::class, 'cefa.createAccidents'])->name('create');
    ...
    Route::prefix('incidents/{incidentId}/responses')->name('incidents.responses.')->group(function () {
    ...
    Route::prefix('emergencies/{emergencyId}/responses')->name('emergencies.responses.')->group(function () {
    ...
    Route::prefix('unsafe_acts/{unsafeActId}/responses')->name('unsafe_acts.responses.')->group(function () {
