        ...
        Route::prefix('injury_types')->group(function() {
            ...
            Route::prefix('risk_types')->group(function(){
                ...
                Route::prefix('accidents')->group(function() {
                    Route::get('/', [AccidentTypeController::class,"index"])->name('sstsena.funcionario.accidents.index');
                    Route::get('/create', [AccidentTypeController::class,"create"])->name('sstsena.funcionario.accidents.create');
                    Route::post('/store', [AccidentTypeController::class,"store"])->name('sstsena.funcionario.accidents.store'); 
                    Route::get('/{id}/edit', [AccidentTypeController::class,"edit"])->name('sstsena.funcionario.accidents.edit');
                    Route::put('/{id}/update', [AccidentTypeController::class,"update"])->name('sstsena.funcionario.accidents.update');
                    Route::delete('/{id}/destroy', [AccidentTypeController::class,"destroy"])->name('sstsena.funcionario.accidents.destroy');    
                });
            });
        });
    });
