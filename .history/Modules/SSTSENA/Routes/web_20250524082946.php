    ...
    Route::prefix('SSTSENA')->group(function() {
        ...
        Route::prefix('injury_types')->group(function() {
          ...
          Route::prefix('accident_types')->group(function() {
            ...
            Route::get('/create', [AccidentController::class,"create"])->name('sstsena.admin.accident_types.create');
            Route::post('/store', [AccidentController::class,"store"])->name('sstsena.admin.accident_types.store'); 
            Route::get('/{id}/edit', [AccidentController::class,"edit"])->name('sstsena.admin.accident_types.edit');
            Route::put('/{id}/update', [AccidentController::class,"update"])->name('sstsena.admin.accident_types.update');
            Route::delete('/{id}/destroy', [AccidentController::class,"destroy"])->name('sstsena.admin.accident_types.destroy');
          });
        });
    });
});
