                ...
                Route::prefix('accidents')->group(function() {
                 ...
                 Route::prefix('TypePerson')->group(function() { 
                  ...
                  Route::prefix('people_involved')->group(function() { 
                    Route::get('/', [TypePersonController::class,"index"])->name('sstsena.f.people_involved.index');
                    Route::get('/create', [TypePersonController::class,"create"])->name('sstsena.f.people_involved.create');
                    Route::post('/store', [TypePersonController::class,"store"])->name('sstsena.f.people_involved.store');
                    Route::get('/{id}/edit', [TypePersonController::class,"edit"])->name('sstsena.f.people_involved.edit');
                    Route::put('/{id}/update', [TypePersonController::class,"update"])->name('sstsena.f.people_involved.update');
                    Route::delete('/{id}/destroy', [TypePersonController::class,"destroy"])->name('sstsena.f.people_involved.destroy');      
                });
            });
        });
    });
