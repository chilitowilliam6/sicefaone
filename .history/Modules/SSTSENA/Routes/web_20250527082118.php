            ...
            Route::prefix('risk_types')->group(function(){
                ...
                Route::prefix('accidents')->group(function() {
                 ...
                 Route::prefix('TypePerson')->group(function() { 
                    Route::get('/', [TypePerson::class,"index"])->name('sstsena.funcionario.TypePerson.index');
                    Route::get('/create', [TypePerson::class,"create"])->name('sstsena.funcionario.TypePerson.create');
