...
Route::middleware(['lang'])->group(function () { // Middleware que permite la internacionalización
    ...
    Route::get('/events', [EventController::class, 'index'])->name('cefa.events.index');

   Route::prefix('accidents/{accidentId}/responses')->name('cefa.sstsena.accidents.responses.')->group(function () {
    ...
    Route::prefix('incidents/{incidentId}/responses')->name('cefa.incidents.responses.')->group(function () {
