                ...
                Route::prefix('accidents')->group(function() {
                 ...
                 Route::prefix('TypePerson')->group(function() { 
                  ...
                  Route::prefix('people_involved')->group(function() { 
                    Route::get('/', [PeopleIController::class,"index"])->name('sstsena.funcionario.people_involved.index');
                    Route::get('/create', [PeopleIController::class,"create"])->name('sstsena.funcionario.people_involved.create');
                    Route::post('/store', [PeopleIController::class,"store"])->name('sstsena.funcionario.people_involved.store');
                    Route::get('/{id}/edit', [PeopleIController::class,"edit"])->name('sstsena.funcionario.people_involved.edit');
                    Route::put('/{id}/update', [PeopleIController::class,"update"])->name('sstsena.funcionario.people_involved.update');
                    Route::delete('/{id}/destroy', [PeopleIController::class,"destroy"])->name('sstsena.funcionario.people_involved.destroy');      
                });
            });
        });
    });
