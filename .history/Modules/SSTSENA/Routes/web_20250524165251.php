        ...
        Route::prefix('injury_types')->group(function() {
            ...
            Route::prefix('risk_types')->group(function(){
                ...
                Route::prefix('accidents')->group(function() {
                    Route::get('/', [AccidentTypeController::class,"index"])->name('sstsena.admin.accidents.index');
                    Route::get('/create', [AccidentTypeController::class,"create"])->name('sstsena.admin.accidents.create');
                    Route::post('/store', [AccidentTypeController::class,"store"])->name('sstsena.admin.accidents.store'); 
                    Route::get('/{id}/edit', [AccidentTypeController::class,"edit"])->name('sstsena.admin.accidents.edit');
                    Route::put('/{id}/update', [AccidentTypeController::class,"update"])->name('sstsena.admin.accidents.update');
                    Route::delete('/{id}/destroy', [AccidentTypeController::class,"destroy"])->name('sstsena.admin.accidents.destroy');    
                });
            });
        });
    });
