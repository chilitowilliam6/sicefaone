    ...
    Route::prefix('SSTSENA')->group(function() {
        ...
        Route::prefix('injury_types')->group(function() {
          ...
          Route::prefix('accident_types')->group(function() {
            ...
            Route::get('/create', [Controller::class,"create"])->name('sstsena.admin.accident_types.create');
            Route::post('/store', [Controller::class,"store"])->name('sstsena.admin.accident_types.store'); 
            Route::get('/{id}/edit', [Controller::class,"edit"])->name('sstsena.admin.accident_types.edit');
            Route::put('/{id}/update', [Controller::class,"update"])->name('sstsena.admin.accident_types.update');
            Route::delete('/{id}/destroy', [Controller::class,"destroy"])->name('sstsena.admin.accident_types.destroy');
           });
        });
      });
    });
