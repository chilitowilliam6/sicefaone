    ...
    Route::prefix('SSTSENA')->group(function() {
        ...
        Route::prefix('injury_types')->group(function() {
          ...
          Route::prefix('accident_types')->group(function() {
            Route::get('/', [AccidentTController::class,"index"])->name('sstsena.admin.accident_types.index');
            Route::get('/create', [RiskTypeController::class,"create"])->name('sstsena.admin.accident_types.create');
            Route::post('/store', [RiskTypeController::class,"store"])->name('sstsena.admin.accident_types.store'); 
            Route::get('/{id}/edit', [RiskTypeController::class,"edit"])->name('sstsena.admin.accident_types.edit');
            Route::put('/{id}/update', [RiskTypeController::class,"update"])->name('sstsena.admin.accident_types.update');
            Route::delete('/{id}/destroy', [RiskTypeController::class,"destroy"])->name('sstsena.admin.accident_types.destroy');
          });
        });
    });
});
