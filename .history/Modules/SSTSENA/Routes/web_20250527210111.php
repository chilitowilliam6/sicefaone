                ...
                Route::prefix('accidents')->group(function() {
                 ...
                 Route::prefix('TypePerson')->group(function() { 
                  ...
                  Route::prefix('people_involved')->group(function() { 
                    Route::get('/', [PersonController::class,"index"])->name('sstsena.funcionario.people_involved.index');
                    Route::get('/create', [PersonController::class,"create"])->name('sstsena.funcionario.people_involved.create');
                    Route::post('/store', [PersonController::class,"store"])->name('sstsena.funcionario.people_involved.store');
                    Route::get('/{id}/edit', [PersonController::class,"edit"])->name('sstsena.funcionario.people_involved.edit');
                    Route::put('/{id}/update', [PersonController::class,"update"])->name('sstsena.funcionario.people_involved.update');
                    Route::delete('/{id}/destroy', [PersonController::class,"destroy"])->name('sstsena.funcionario.people_involved.destroy');      
                });
            });
        });
    });
