...
Route::middleware(['lang'])->group(function () { // Middleware que permite la internacionalización
        ...
        Route::prefix('people_involved')->group(function () {
            ...
            Route::get('/', [PeopleInvolvedController::class, "index"])->name('sstsena.admin.people_involved.index');
            Route::get('/create', [PeopleInvolvedController::class, "create"])->name('sstsena.admin.people_involved.create');
            Route::post('/store', [PeopleInvolvedController::class, "store"])->name('sstsena.admin.people_involved.store');
            Route::get('/{id}/edit', [PeopleInvolvedController::class, "edit"])->name('sstsena.admin.people_involved.edit');
            Route::put('/{id}/update', [PeopleInvolvedController::class, "update"])->name('sstsena.admin.people_involved.update');
            Route::delete('/{id}/destroy', [PeopleInvolvedController::class, "destroy"])->name('sstsena.admin.people_involved.destroy');
            });
        });
