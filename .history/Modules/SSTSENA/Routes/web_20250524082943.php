    ...
    Route::prefix('SSTSENA')->group(function() {
        ...
        Route::prefix('injury_types')->group(function() {
          ...
          Route::prefix('accident_types')->group(function() {
            ...
            Route::get('/create', [AController::class,"create"])->name('sstsena.admin.accident_types.create');
            Route::post('/store', [AController::class,"store"])->name('sstsena.admin.accident_types.store'); 
            Route::get('/{id}/edit', [AController::class,"edit"])->name('sstsena.admin.accident_types.edit');
            Route::put('/{id}/update', [AController::class,"update"])->name('sstsena.admin.accident_types.update');
            Route::delete('/{id}/destroy', [AController::class,"destroy"])->name('sstsena.admin.accident_types.destroy');
          });
        });
    });
});
