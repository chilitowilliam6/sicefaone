    ...
    Route::prefix('SSTSENA')->group(function() {
        ...
        Route::prefix('injury_types')->group(function() {
          ...
          Route::prefix('risk_types')->group(function(){
            Route::get('/', [risk_typeController::class,"index"])->name('sstsena.admin.risk_types.index');
            Route::get('/create', [risk_typeController::class,"create"])->name('sstsena.admin.risk_types.create');
