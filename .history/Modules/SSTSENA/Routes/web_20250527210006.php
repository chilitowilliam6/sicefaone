                ...
                Route::prefix('accidents')->group(function() {
                 ...
                 Route::prefix('TypePerson')->group(function() { 
                  ...
                  Route::prefix('people_involved')->group(function() { 
                    Route::get('/', [TypePersonController::class,"index"])->name('sstsena.funcionario.people_involved.index');
                    Route::get('/create', [TypePersonController::class,"create"])->name('sstsena.funcionario.people_involved.create');
                    Route::post('/store', [TypePersonController::class,"store"])->name('sstsena.funcionario.people_involved.store');
                    Route::get('/{id}/edit', [TypePersonController::class,"edit"])->name('sstsena.funcionario.people_involved.edit');
                    Route::put('/{id}/update', [TypePersonController::class,"update"])->name('sstsena.funcionario.people_involved.update');
                    Route::delete('/{id}/destroy', [TypePersonController::class,"destroy"])->name('sstsena.funcionario.people_involved.destroy');      
                });
            });
        });
    });
