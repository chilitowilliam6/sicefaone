...
Route::middleware(['lang'])->group(function () { // Middleware que permite la internacionalización
    ...
    Route::prefix('SSTSENA')->group(function () {
        ...
        Route::prefix('{eventType}/{eventId}/responses')->group(function () {
        Route::get('/', [EventResponseController::class, 'index'])->name('cefa.event_responses.index');
        Route::get('/create', [EventResponseController::class, 'create'])->name('cefa.event_responses.create');
        Route::post('/', [EventResponseController::class, 'store'])->name('cefa.event_responses.store');
        Route::get('/{id}/edit', [EventResponseController::class, 'edit'])->name('cefa.event_responses.edit');
        Route::put('/{id}', [EventResponseController::class, 'update'])->name('cefa.event_responses.update');
        Route::delete('/{id}', [EventResponseController::class, 'destroy'])->name('cefa.event_responses.destroy');
    });
