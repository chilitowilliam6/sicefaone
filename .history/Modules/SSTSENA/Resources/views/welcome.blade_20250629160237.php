    ...
    <div class="space-y-6 text-center md:text-left">
      ...
      <div class="flex flex-col sm:flex-row flex-wrap justify-center md:justify-start gap-4">
        @auth
          ...
          @if (checkRol('sstsena.funcionario'))
            <a href="{{ route('sstsena.incidents.responses.index') }}" class="inline-flex items-center gap-2 px-6 py-3 bg-orange-500 text-white rounded-lg font-semibold hover:bg-blue-600 transition">
