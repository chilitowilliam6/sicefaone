    ...
    <div class="card shadow-sm rounded-3 welcome-card" style="background-color: #ffffff;">
        ...
        <div class="card-body p-5 fade-in">
            ...
            <div class="d-flex justify-content-center gap-3 mt-5">
                <a href="{{ route('sstsena.admin.reports.create') }}" class="btn btn-primary px-5 py-2" style="background-color: #1a3c6e; border-color: #1a3c6e; font-size: 1.1rem;">Iniciar Reporte</a>
                <a href="{{ route('sstsena.admin.dashboard') }}" class="btn btn-outline-secondary px-5 py-2" style="border-color: #6c757d; color: #34495e;">Explorar Funciones</a>
            </div>
        </div>
    </div>
</div>
