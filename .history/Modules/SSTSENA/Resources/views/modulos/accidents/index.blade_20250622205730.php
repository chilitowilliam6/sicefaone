        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" style="margin-top: 10vh;">
            <div class="modal-content" style="padding: 0.75rem;">
                <div class="modal-header bg-light" style="padding: 0.75rem 1rem;">
                    <h5 class="modal-title text-primary" id="agregarPersonaModalLabel" style="font-size: 1rem; text-align: center; width: 100%;">
                    ...
                    <form action="{{ route('sstsena.funcionario.people_involved.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="mb-2 col-md-6">
                                <label for="document_type" class="form-label" style="font-size: 0.9rem;">Tipo de Documento</label>
                            ...
                            <div class="mb-2 col-md-6">
                                <label for="document_number" class="form-label" style="font-size: 0.9rem;">Número de Documento</label>
                                <input type="text" name="document_number" id="document_number" class="form-control form-control-sm" required>
                            </div>
                            <div class="mb-2 col-md-6">
                                <label for="name" class="form-label" style="font-size: 0.9rem;">Nombre</label>
                                <input type="text" name="name" id="name" class="form-control form-control-sm" required>
                            </div>
                            <div class="mb-2 col-md-6">
                                <label for="last_name" class="form-label" style="font-size: 0.9rem;">Apellido</label>
                                <input type="text" name="last_name" id="last_name" class="form-control form-control-sm" required>
                            </div>
                            <div class="mb-2 col-md-6">
                                <label for="birth_date" class="form-label" style="font-size: 0.9rem;">Fecha de Nacimiento</label>
                                <input type="date" name="birth_date" id="birth_date" class="form-control form-control-sm" required>
                            </div>
                            <div class="mb-2 col-md-6">
                                <label for="gender" class="form-label" style="font-size: 0.9rem;">Género</label>
                            ...
                            <div class="mb-2 col-md-6">
                                <label for="person_type_id" class="form-label" style="font-size: 0.9rem;">Tipo de Persona</label>
                            ...
                            <div class="mb-2 col-md-6">
                                <label for="phone" class="form-label" style="font-size: 0.9rem;">Teléfono</label>
                                <input type="text" name="phone" id="phone" class="form-control form-control-sm">
                            </div>
                            <div class="mb-2 col-md-12">
                                <label for="address" class="form-label" style="font-size: 0.9rem;">Dirección</label>
                                <input type="text" name="address" id="address" class="form-control form-control-sm">
                            </div>
                            <div class="mb-2 col-md-12">
                                <label for="accident_id" class="form-label" style="font-size: 0.9rem;">Accidente Asociado</label>
                        ...
                        <div class="text-center mt-2">
                            <button type="submit" class="corporate-btn" style="border-color: #28a745; background: #d4edda; color: #155724; font-size: 0.85rem; padding: 0.4rem 0.8rem;">Guardar</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="descriptionModalLabel">Despecting Completa</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
