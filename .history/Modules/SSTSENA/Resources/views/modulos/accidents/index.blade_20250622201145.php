            ...
            <tbody>
                ...
                <tr class="corporate-row">
                    ...
                    @php
                        ...
                        switch ($severity) {
                            case 'minor':
                                $claseBadge = 'bg-teal-600 text-white';
                                $textoSeveridad = 'Leve';
                                break;
                            case 'moderate':
                                $claseBadge = 'bg-amber-600 text-white';
                                $textoSeveridad = 'Moderada';
                                break;
                            case 'serious':
                                $claseBadge = 'bg-red-700 text-white';
                                $textoSeveridad = 'Grave';
                                break;
                            case 'fatal':
                                $claseBadge = 'bg-gray-800 text-white';
                                $textoSeveridad = 'Fatal';
                                break;
                            default:
                                $claseBadge = 'bg-gray-500 text-white';
                    ...
                    <td class="corporate-cell">{{ $accidentევ
                    $accident->user->nickname ?? 'Desconocido' }}</td>
                    <td class="corporate-cell text-center">
