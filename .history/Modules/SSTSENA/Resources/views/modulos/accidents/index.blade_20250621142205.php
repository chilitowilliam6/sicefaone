                ...
                <div class="px-4 py-3">
                    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-3">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('sstsena.funcionario.accidents.create') }}" class="corporate-btn" style="border: 2px solid #28a745; background: #d4edda; color: #155724;">
                                <i class="fas fa-plus-circle me-1"></i>
                                <span>Nuevo Accidente</span>
                            </a>
                            <button class="corporate-btn" style="border: 2px solid #007bff; background: #d1ecf1; color: #0c5460;" data-bs-toggle="modal" data-bs-target="#agregarPersonaModal">
                        ...
                        <div class="d-flex align-items-end gap-2">
                            <form method="GET" action="{{ route('sstsena.funcionario.accidents.index') }}" class="d-flex align-items-end gap-2">
                                <div>
                                    ...
                                    <input type="date" id="fecha" name="fecha" class="form-control form-control-sm" value="{{ request('fecha') }}" style="width: 180px;">
                                </div>
                                <button type="submit" class="corporate-btn" style="border: 2px solid #6c757d;">
                                    <i class="fas fa-search me-1"></i>
                                    <span>Filtrar</span>
                                </button>
                                <a href="{{ route('sstsena.funcionario.accidents.index') }}" class="corporate-btn" style="border: 2px solid #6c757d;">
                                        ...
                                        @switch(strtolower($accident->severity))
                                            ...
                                            @default
                                                <span class="severity-badge severity-pending">
                                                    <div class="severity-indicator"></div>
                                                    <span>{{ ucfirst($accident->severity) }}</span>
                                                </span>
                                        @endswitch
                                    </td>
                                    <td class="corporate-cell text-center">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#{{ $evidenceModalId }}">
                                            <img src="{{ asset('storage/evidences/' . $accident->evidence) }}" alt="Evidencia"
                                                class="img-thumbnail" style="inline-size: 60px; block-size: 60px; object-fit: cover; border: 2px solid #e9ecef;">
                                        </a>
                                        ...
                                        <a href="{{ asset('storage/evidences/' . $accident->evidence) }}"
                                            class="corporate-btn" style="border: 2px solid #007bff; background: #d1ecf1; color: #0c5460;" target="_blank">
