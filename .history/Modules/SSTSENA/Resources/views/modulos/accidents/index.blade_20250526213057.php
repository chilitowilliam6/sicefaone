        ...
        <tbody>
            @forelse ($accidents as $accident)
                <tr>
                    ...
                    <td>
                        <a href="#" class="btn btn-sm me-1" style="background-color: #26a69a; border-color: #26a69a; color: white;">
                            Editar
                        </a>
                        <a href="#" class="btn btn-sm" style="background-color: #ef5350; border-color: #ef5350; color: white;">
                            Eliminar
                        </a>
                    </td>
                </tr>
