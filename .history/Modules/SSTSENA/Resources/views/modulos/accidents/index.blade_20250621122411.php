            ...
            <div class="corporate-card border-0 shadow-sm">
                ...
                <div class="modal fade" id="agregarPersonaModal" tabindex="-1" aria-labelledby="agregarPersonaModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-dark fw-semibold" id="agregarPersonaModalLabel">Crear Persona Involucrada</h5>
                                ...
                                <form action="{{ route('sstsena.funcionario.people_involved.store') }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label for="document_type" class="form-label small text-muted">Tipo de Documento</label>
                                        ...
                                        <!-- Número de Documento -->
                                        <div class="mb-3 col-md-6">
                                            <label for="document_number" class="form-label small text-muted">Número de Documento</label>
                                        ...
                                        <!-- Apellido -->
                                        <div class="mb-3 col-md-6">
                                            <label for="last_name" class="form-label small text-muted">Apellido</label>
                                            <input type="text" name="last_name" id="last_name" class="form-control form-control-sm" required>
                                        </div>
                                        <!-- Fecha de Nacimiento -->
                                        <div class="mb-3 col-md-6">
                                            <label for="birth_date" class="form-label small text-muted">Fecha de Nacimiento</label>
                                            <input type="date" name="birth_date" id="birth_date" class="form-control form-control-sm" required>
                                        </div>
                                        <!-- Género -->
                                        <div class="mb-3 col-md-6">
                                            <label for="gender" class="form-label small text-muted">Género</label>
                                        ...
                                        <!-- Tipo de Persona -->
                                        <div class="mb-3 col-md-6">
                                            <label for="person_type_id" class="form-label small text-muted">Tipo de Persona</label>
                                        ...
                                        <div class="mb-3 col-md-12">
                                            <label for="address" class="form-label small text-muted">Dirección</label>
                                            <input type="text" name="address" id="address" class="form-control form-control-sm">
                                        </div>
                                        <!-- Relación con Accidente -->
                                        <div class="mb-3 col-md-12">
                                            <label for="accident_id" class="form-label small text-muted">Accidente Asociado</label>
