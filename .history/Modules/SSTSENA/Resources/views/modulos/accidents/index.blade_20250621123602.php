...
<div class="text-center mb-4 d-flex justify-content-center gap-3 align-items-center">
    <div class="d-flex align-items-center me-3" style="color: #34495e; font-weight: 600;">
        <i class="bi bi-file-earmark-text-fill me-2" style="font-size: 1.5rem;"></i>
        <span class="text-muted">Registros: {{ $accidents->count() }}</span>
    </div>
    <a href="{{ route('sstsena.funcionario.accidents.create') }}" class="btn btn-success">
        <i class="bi bi-plus-lg me-1"></i> Agregar Accidente
    </a>
    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#agregarPersonaModal">
        <i class="bi bi-person-plus-fill me-1"></i> Agregar Personas Involucradas
    </button>
</div>
