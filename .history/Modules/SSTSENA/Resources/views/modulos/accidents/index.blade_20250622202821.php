...
@php
    ...
    switch ($severity) {
        case 'minor':
            $claseBadge = 'text-dark'; // sin color azul
            $estiloInline = 'background-color: #e6f4ea;'; // verde pálido
            $textoSeveridad = 'Leve';
            break;
        case 'moderate':
            $claseBadge = 'text-dark';
            $estiloInline = 'background-color: #fff3cd;'; // ámbar claro
            $textoSeveridad = 'Moderada';
            break;
        case 'serious':
            $claseBadge = 'text-dark';
            $estiloInline = 'background-color: #f8d7da;'; // rojo claro
            $textoSeveridad = 'Grave';
            break;
        case 'fatal':
            $claseBadge = 'text-light';
            $estiloInline = 'background-color: #343a40;'; // gris oscuro
            $textoSeveridad = 'Fatal';
            break;
        default:
            $claseBadge = 'text-dark';
            $estiloInline = 'background-color: #e2e3e5;'; // gris neutro
...
<td class="corporate-cell">
    <span class="badge {{ $claseBadge }}" style="padding: 0.5em 1em; border-radius: 0.25rem; font-weight: 600; {{ $estiloInline }}">
        {{ $textoSeveridad }}
    </span>
</td>
...
/* Colores profesionales para los badges de severidad */
.bg-success-soft {
