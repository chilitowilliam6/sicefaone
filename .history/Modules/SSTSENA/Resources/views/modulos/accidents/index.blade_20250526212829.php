        ...
        <tbody>
            @forelse ($accidents as $accident)
                <tr>
                    ...
                    <td>
                        <a href="#" class="btn btn-sm btn-warning me-1" style="background-color: #ffc107; border-color: #ffc107;">
                            Editar
                        </a>
                        <a href="#" class="btn btn-sm btn-danger" style="background-color: #dc3545; border-color: #dc3545;">
                            Eliminar
                        </a>
                    </td>
                </tr>
