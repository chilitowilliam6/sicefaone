        ...
        <table class="table table-hover mb-0 corporate-table">
            ...
            <tbody>
                ...
                <tr class="corporate-row">
                    ...
                    <td class="corporate-cell">
                        <span class="badge rounded-pill {{ $accident->severity == 'Minor' ? 'bg-success' : ($accident->severity == 'Moderate' ? 'bg-warning' : ($accident->severity == 'Serious' ? 'bg-danger' : 'bg-dark')) }}">
                            {{ $accident->severity == 'Minor' ? 'Menor' : ($accident->severity == 'Moderate' ? 'Moderada' : ($accident->severity == 'Serious' ? 'Grave' : 'Fatal')) }}
                        </span>
                    </td>
...
// Clear modals on close to avoid conflicts
document.addEventListener('DOMContentLoaded', function() {
    // Clear description modal
