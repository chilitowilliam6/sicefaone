...
@section('content')
<h2 class="text-center fw-bold mb-4" style="color: #0d47a1; border-bottom: 3px solid #0d6efd; display: inline-block; padding-bottom: 0.5rem;">
    <i class="bi bi-clipboard2-pulse-fill me-2"></i> Lista de Accidentes
</h2>
...
<div class="card shadow-sm p-3 mb-4 bg-white rounded border-0">
    <div class="d-flex flex-wrap justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center mb-2 mb-md-0">
            <i class="bi bi-clipboard-data text-primary me-2" style="font-size: 1.8rem;"></i>
