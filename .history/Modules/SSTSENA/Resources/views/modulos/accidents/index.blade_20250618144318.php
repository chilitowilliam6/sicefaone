                                    ...
                                    <tr class="corporate-row">
                                        ...
                                        <td class="corporate-cell midterm-ignore">
                                            <div class="description-content">
                                                <p class="mb-0 text-dark lh-sm">
                                                    {{ $accident->environment->name ?? 'N/A' }}
                                                </p>
                                            </div>
                                        </td>
                                        <td class="corporate-cell midterm-ignore">
                                        ...
                                        <td class="corporate-cell midterm-ignore">
                                            <div class="description-content">
                                                <p class="mb-0 text-dark lh-sm">
                                                    {{ $accident->accidentType->name ?? 'N/A' }}
                                                </p>
                                            </div>
                                        </td>
                                        <td class="corporate-cell midterm-ignore">
                                            <div class="description-content">
                                                <p class="mb-0 text-dark lh-sm expandable-text" id="description-{{ $accident->id }}"
                                                   style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                    {{ $accident->description ?? 'Sin descripción disponible' }}
                                                </p>
                                        ...
                                        <td class="corporate-cell midterm-ignore text-center align-middle">
                    ...
                    <form action="{{ route('sstsena.funcionario.people_involved.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="document_type" id="document_type" class="form-select form-control-sm" required>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="gender" id="gender" class="form-select form-control-sm" required>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="person_type_id" id="person_type_id" class="form-select form-control-sm" required>
                                    <option value="">Seleccione una opción</option>
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <select name="accident_id" id="accident_id" class="form-select form-control-sm" required>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="corporate-btn" data-bs-dismiss="modal">Cancelar</button>
                            <button type="submit" class="corporate-btn corporate-btn-edit" style="border-color: #28a745;">Guardar</button>
                        </div>
                    </form>
                </div>
            </div>
