                    ...
                    <td>
                        <span class="badge" 
                              style="padding: 0.5em 1em; border-radius: 0.25rem; 
                                     @if($accident->severity == 'minor') background-color: #28a745; color: #ffffff;
                                     @elseif($accident->severity == 'moderate') background-color: #ffc107; color: #212529;
                                     @elseif($accident->severity == 'serious') background-color: #fd7e14; color: #ffffff;
                                     @elseif($accident->severity == 'fatal') background-color: #dc3545; color: #ffffff;
                                     @endif">
