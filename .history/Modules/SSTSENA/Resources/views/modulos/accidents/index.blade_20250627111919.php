...
<div class="corporate-card shadow-sm mb-4">
    ...
    <div class="modal fade" id="agregarPersonaModal" tabindex="-1" aria-labelledby="agregarPersonaModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" style="margin-top: 10vh;">
            <div class="modal-content" style="padding: 0.5rem;">
                <div class="modal-header bg-light" style="padding: 0.5rem 0.75rem;">
                    <h5 class="modal-title text-primary" id="agregarPersonaModalLabel" style="font-size: 0.95rem; text-align: center; width: 100%;">
                        Registrar Persona Involucrada
                    </h5>
                    <button type="button" class="btn-close btn-close-sm" data-bs-dismiss="modal" aria-label="Close" style="transform: scale(0.85);"></button>
                </div>
                    ...
                    <form action="{{ route('sstsena.funcionario.people_involved.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="mb-1 col-md-6">
                                <label for="document_type" class="form-label" style="font-size: 0.85rem;">Tipo de Documento</label>
                                <select name="document_type" id="document_type" class="form-select form-select-sm" required>
                            ...
                            <div class="mb-1 col-md-6">
                                <label for="document_number" class="form-label" style="font-size: 0.85rem;">Número de Documento</label>
                                <input type="text" name="document_number" id="document_number" class="form-control form-control-sm" required>
                            </div>
                            <div class="mb-1 col-md-6">
                                <label for="name" class="form-label" style="font-size: 0.85rem;">Nombre</label>
                                <input type="text" name="name" id="name" class="form-control form-control-sm" required>
                            </div>
                            <div class="mb-1 col-md-6">
                                <label for="last_name" class="form-label" style="font-size: 0.85rem;">Apellido</label>
                                <input type="text" name="last_name" id="last_name" class="form-control form-control-sm" required>
                            </div>
                            <div class="mb-1 col-md-6">
                                <label for="birth_date" class="form-label" style="font-size: 0.85rem;">Fecha de Nacimiento</label>
                                <input type="date" name="birth_date" id="birth_date" class="form-control form-control-sm" required>
                            </div>
                            <div class="mb-1 col-md-6">
                                <label for="gender" class="form-label" style="font-size: 0.85rem;">Género</label>
                            ...
                            <div class="mb-1 col-md-6">
                                <label for="person_type_id" class="form-label" style="font-size: 0.85rem;">Tipo de Persona</label>
                                <select name="person_type_id" id="person_type_id" class="form-select form-select-sm" required>
                                    <option value="">Seleccione una opción</option>
                            ...
                            <div class="mb-1 col-md-6">
                                <label for="phone" class="form-label" style="font-size: 0.85rem;">Teléfono</label>
                                <input type="text" name="phone" id="phone" class="form-control form-control-sm">
                            </div>
                            <div class="mb-1 col-md-12">
                                <label for="address" class="form-label" style="font-size: 0.85rem;">Dirección</label>
                                <input type="text" name="address" id="address" class="form-control form-control-sm">
                            </div>
                            <div class="mb-1 col-md-12">
                                <label for="accident_id" class="form-label" style="font-size: 0.85rem;">Accidente Asociado</label>
                                <select name="accident_id" id="accident_id" class="form-select form-select-sm" required>
                        ...
                        <div class="text-center mt-1">
                            <button type="submit" class="corporate-btn" style="border-color: #28a745; background: #d4edda; color: #155724; font-size: 0.8rem; padding: 0.35rem 0.7rem;">Guardar</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <table class="table table-hover mb-0 corporate-table">
            <thead>
                <tr class="corporate-header-row">
                    ...
                    <th class="corporate-th">Descripción del Accidente</th>
...
<td class="corporate-cell midterm-ignore">
    <div class="created-by-info">
        <span class="fw-semibold text-dark">
            {{ $accident->user->person->first_name ?? 'Desconocido' }}
            {{ $accident->user->person->last_name ?? '' }}
        </span>
    ...
    <a href="{{ route('sstsena.accidents.responses.index', $accident->id) }}" class="corporate-btn">
