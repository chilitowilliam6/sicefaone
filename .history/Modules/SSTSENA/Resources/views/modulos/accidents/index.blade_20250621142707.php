...
<div class="card shadow-sm p-3 mb-4 bg-white rounded border-0">
    <div class="d-flex flex-wrap justify-content-between align-items-center">
        <!-- Botones de acción -->
        <div class="d-flex gap-2 mb-2 mb-md-0 me-3">
        ...
        <div class="d-flex align-items-center mb-2 mb-md-0 me-3">
            <form method="GET" action="{{ route('sstsena.funcionario.accidents.index') }}" class="d-flex align-items-center gap-2">
                <div>
                    <label for="fecha" class="form-label visually-hidden">Fecha de Registro</label>
                    <input type="date" id="fecha" name="fecha" class="form-control" value="{{ request('fecha') }}" style="width: 180px;">
                </div>
                <button type="submit" class="btn btn-primary btn-sm">
                    <i class="bi bi-search"></i> Filtrar
                </button>
                <a href="{{ route('sstsena.funcionario.accidents.index') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="d-flex align-items-center mb-2 mb-md-0">
            <div class="text-center p-3" style="min-width: 120px;">
                <h2 class="mb-1 text-dark fw-bold">{{ $accidents->count() }}</h2>
                <small class="text-muted text-uppercase fw-medium">REGISTROS</small>
            </div>
        </div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    {{ $shortDescription }}
                    @if($isLong)
                        <a href="#" data-bs-toggle="modal" data-bs-target="#{{ $modalId }}" class="text-primary text-decoration-none">Ver más</a>
                        <!-- Modal para descripción completa -->
                        <div class="modal fade" id="{{ $modalId }}" tabindex="-1" aria-labelledby="{{ $modalId }}Label" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="{{ $modalId }}Label">Descripción Completa</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                    </div>
                                    <div class="modal-body">
                                        <p>{{ $description }}</p>
