                ...
                <tr class="corporate-row">
                    ...
                    <td class="corporate-cell">
                        <span class="severity-badge 
                            @if($accident->severity == 'Minor') severity-low
                            @elseif($accident->severity == 'Moderate') severity-medium
                            @elseif($accident->severity == 'Serious') severity-high
                            @elseif($accident->severity == 'Fatal') severity-critical
                            @else severity-pending
                            @endif">
                            <div class="severity-indicator"></div>
                            <span>
                                @if($accident->severity == 'Minor') Menor
                                @elseif($accident->severity == 'Moderate') Moderada
                                @elseif($accident->severity == 'Serious') Grave
                                @elseif($accident->severity == 'Fatal') Fatal
                                @else No definido
                                @endif
                            </span>
                        </span>
