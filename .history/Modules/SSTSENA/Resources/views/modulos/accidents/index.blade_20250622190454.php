...
<div class="corporate-card shadow-sm mb-4">
    ...
    <div class="modal fade" id="agregarPersonaModal" tabindex="-1" aria-labelledby="agregarPersonaModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" style="transform: translateY(10%);">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="gender" id="gender" class="form-select" required>
                                    ...
                                    <option value="Otro>File:///home/user/accidents_index.blade.php</option>
                                </select>
                            </div>
                            <div class="mb-3 col-md-6">
            ...
            <tbody>
                ...
                <tr class="corporate-row">
                    ...
                    @php
                        ...
                        switch ($severity) {
                            case 'minor':
                                $claseBadge = 'bg-severity-minor text-white';
                                $textoSeveridad = 'Leve';
                                break;
                            case 'moderate':
                                $claseBadge = 'bg-severity-moderate text-white';
                                $textoSeveridad = 'Moderada';
                                break;
                            case 'serious':
                                $claseBadge = 'bg-severity-serious text-white';
                                $textoSeveridad = 'Grave';
                                break;
                            case 'fatal':
                                $claseBadge = 'bg-severity-fatal text-white';
                                $textoSeveridad = 'Fatal';
                                break;
                            default:
                                $claseBadge = 'bg-severity-default text-white';
                                $textoSeveridad = $accident->severity;
                                break;
                        }
                    @endphp
                    <td class="corporate-cell">
                        <span class="badge {{ $cl versusBadge }}" style="padding: 0.5em 1em; border-radius: 0.25rem;">
                            {{ $textoSeveridad }}
                        </span>
                    </td>
...
/* Nuevos colores para severidad */
.bg-severity-minor { background-color: #4CAF50 !important; }
.bg-severity-moderate { background-color: #F4A261 !important; }
.bg-severity-serious { background-color: #A61C1C !important; }
.bg-severity-fatal { background-color: #333333 !important; }
.bg-severity-default { background-color: #6c757d !important; }
