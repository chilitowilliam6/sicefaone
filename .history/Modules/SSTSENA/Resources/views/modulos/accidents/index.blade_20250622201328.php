...
@php
    ...
    switch ($severity) {
        case 'minor':
            $claseBadge = 'bg-success-soft text-success-dark';
            $textoSeveridad = 'Leve';
            break;
        case 'moderate':
            $claseBadge = 'bg-warning-soft text-warning-dark';
            $textoSeveridad = 'Moderada';
            break;
        case 'serious':
            $claseBadge = 'bg-danger-soft text-danger-dark';
            $textoSeveridad = 'Grave';
            break;
        case 'fatal':
            $claseBadge = 'bg-dark-soft text-dark';
            $textoSeveridad = 'Fatal';
            break;
        default:
            $claseBadge = 'bg-secondary-soft text-secondary';
...
<td class="corporate-cell">
    <span class="badge {{ $claseBadge }}" style="padding: 0.5em 1em; border-radius: 0.25rem; font-weight: 600;">
        {{ $textoSeveridad }}
    </span>
</td>
...
.corporate-header-row {
    background: linear-gradient(135deg,rgb(8, 98, 187) 0%, #ffffff 100%);
