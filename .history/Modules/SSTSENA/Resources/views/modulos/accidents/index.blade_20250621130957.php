...
<div class="card shadow-sm p-3 mb-4 bg-white rounded border-0">
    <div class="d-flex flex-wrap justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('sstsena.funcionario.accidents.create') }}" class="btn btn-success fw-semibold shadow-sm">
                <i class="bi bi-file-earmark-plus-fill me-1"></i> Nuevo Accidente
            </a>
            <button class="btn btn-primary fw-semibold shadow-sm" data-bs-toggle="modal" data-bs-target="#agregarPersonaModal">
