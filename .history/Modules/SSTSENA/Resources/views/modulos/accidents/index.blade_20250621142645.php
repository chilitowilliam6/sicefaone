...
@media (max-width: 1200px) {
    ...
    .corporate-card { margin-bottom: 1.5rem; }
    .corporate-table thead th { font-size: 0.75rem; }
    .corporate-table tbody td { font-size: 0.85rem; }
    .corporate-btn { font-size: 0.8rem; padding: 0.4rem 0.8rem; }
    .corporate-btn i { font-size: 0.9rem; }
    .corporate-btn span { display: none; }
    .corporate-btn:hover { transform: translateY(-1px); }
    .corporate-btn-edit, .corporate-btn-delete { padding: 0.4rem 0.8rem; }
    .corporate-btn-edit i, .corporate-btn-delete i { font-size: 0.9rem; }
    .corporate-btn-edit span, .corporate-btn-delete span { display: none; }
    .corporate-row { font-size: 0.85rem; }
    .corporate-header-row { font-size: 0.85rem; }
    .corporate-th { padding: 0.75rem 0.5rem; }
    .corporate-cell { padding: 0.75rem 0.5rem; }
    .corporate-table { font-size: 0.85rem; }
    .corporate-table thead th { padding: 0.75rem 0.5rem; }
    .corporate-table tbody td { padding: 0.75rem 0.5rem; }
    .corporate-table tbody td .description-content p {
        max-height: 2.5em;
    }
...
<script>
    ...
    function toggleText(elementId) {
        ...
        const toggleText = element.nextElementSibling;
        const toggleIcon = toggleText.querySelector('.toggle-icon');
        const toggleLabel = toggleText.querySelector('.toggle-label');

        if (element.classList.contains('expanded')) {
            element.style.maxHeight = '3em';
            element.classList.remove('expanded');
            toggleLabel.textContent = 'Mostrar más';
            toggleIcon.style.transform = 'rotate(0deg)';
        } else {
            element.style.maxHeight = element.scrollHeight + 'px';
            element.classList.add('expanded');
            toggleLabel.textContent = 'Mostrar menos';
