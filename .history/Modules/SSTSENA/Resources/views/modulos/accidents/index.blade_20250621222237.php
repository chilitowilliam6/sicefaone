...
<div class="corporate-card shadow-sm">
    ...
    <span class="severity-badge 
        @if($response->severity == 'minor') severity-low
        @elseif($response->severity == 'moderate') severity-medium
        @elseif($response->severity == 'serious') severity-high
        @elseif($response->severity == 'fatal') severity-critical
        @else severity-pending
        @endif">
        <div class="severity-indicator"></div>
        <span>
            @if($response->severity == 'minor') Leve
            @elseif($response->severity == 'moderate') Moderada
            @elseif($response->severity == 'serious') Grave
            @elseif($response->severity == 'fatal') Fatal
            @else No definido
            @endif
        </span>
    </span>
