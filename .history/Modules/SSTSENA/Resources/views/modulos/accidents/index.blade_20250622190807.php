...
@php
    ...
    switch ($severity) {
        case 'minor':
            $claseBadge = 'text-white';
            $estiloPersonalizado = 'background-color: #1e88e5;';
            $textoSeveridad = 'Leve';
            break;
        case 'moderate':
            $claseBadge = 'text-dark';
            $estiloPersonalizado = 'background-color: #ffb300;';
            $textoSeveridad = 'Moderada';
            break;
        case 'serious':
            $claseBadge = 'text-white';
            $estiloPersonalizado = 'background-color: #e53935;';
            $textoSeveridad = 'Grave';
            break;
        case 'fatal':
            $claseBadge = 'text-white';
            $estiloPersonalizado = 'background-color: #37474f;';
            $textoSeveridad = 'Fatal';
            break;
        default:
            $claseBadge = 'text-white';
            $estiloPersonalizado = 'background-color: #9e9e9e;';
...
<td class="corporate-cell">
    <span class="badge {{ $claseBadge }}" style="padding: 0.45em 1em; border-radius: 0.5rem; font-size: 0.9rem; {{ $estiloPersonalizado }}">
        {{ $textoSeveridad }}
    </span>
</td>
