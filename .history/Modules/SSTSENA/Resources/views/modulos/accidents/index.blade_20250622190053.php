        ...
        <table class="table table-hover mb-0 corporate-table">
            ...
            <tbody>
                ...
                <tr class="corporate-row">
                    ...
                    @endphp
                    <td class="corporate-cell">
                        <span class="badge {{ $claseBadge }}" style="padding: 0.5em 1em; border-radius: 0.25rem;">
                            {{ $textoSeveridad }}
                        </span>
                    </td>
...
.bg-severity-minor { background-color: #4CAF50; }
.bg-severity-moderate { background-color: #F4A261; }
.bg-severity-serious { background-color: #A61C1C; }
.bg-severity-fatal { background-color: #333333; }
.bg-severity-default { background-color: #6c757d; }
