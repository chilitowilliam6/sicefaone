...
<div class="modal fade" id="agregarPersonaModal" tabindex="-1" aria-labelledby="agregarPersonaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-scrollable mt-5">
        <div class="modal-content">
            <br>
            <div class="modal-header bg-light">
                <h5 class="modal-title text-primary text-center w-100" id="agregarPersonaModalLabel">
                    <i class="bi bi-person-plus-fill me-2"></i> Crear Persona Involucrada
                </h5>
