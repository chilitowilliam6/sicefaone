    ...
    <div class="row g-4">
        ...
        <div class="col-12 section-item">
            <div class="corporate-card border-0 shadow-sm">
                ...
                <!-- Buttons -->
                <div class="px-4 py-3">
                    <div class="d-flex align-items-end mb-3 gap-3 justify-content-start">
                ...
                <div class="modal fade" id="agregarPersonaModal" tabindex="-1" aria-labelledby="agregarPersonaModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header" style="border-bottom: 1px solid var(--corporate-border);">
                                        ...
                                        <td class="corporate-cell midterm-ignore">
                                            @if($accident->evidence)
                                                @php
                                                    ...
                                                    $modalId = 'evidence modular' . $accident->id;
                                                @endphp
...
@media (max-width: 768px) {
    ...
    .d-flex.align-items-end.mb-3.gap-3.justify-content-start {
        flex-direction: column;
        align-items: flex-start !important;
        gap: 1rem;
    }
