...
<!-- Estilo compacto, dinámico y alineado a la izquierda -->
<div class="col-md-6 d-flex align-items-center mb-3 mb-md-0">
    <div class="d-flex align-items-center gap-3">
        <div class="bg-light rounded-circle d-flex justify-content-center align-items-center shadow-sm" style="width: 40px; height: 40px;">
            <i class="bi bi-bar-chart-fill text-primary fs-5"></i>
        </div>
        <div class="d-flex flex-column">
            <span class="fw-bold text-dark mb-0" style="font-size: 1.5rem;">{{ $accidents->count() }}</span>
            <small class="text-uppercase text-secondary" style="letter-spacing: 0.5px; font-size: 0.75rem;">Registros</small>
        </div>
    </div>
</div>
