...
<div class="card shadow-sm p-3 mb-4 bg-white rounded border-0">
    <form method="GET" action="{{ route('sstsena.funcionario.accidents.index') }}" class="row g-3">
        <div class="col-md-4">
        ...
        <div class="col-md-4 d-flex align-items-end">
            ...
            <a href="{{ route('sstsena.funcionario.accidents.index') }}" class="btn btn-secondary">
