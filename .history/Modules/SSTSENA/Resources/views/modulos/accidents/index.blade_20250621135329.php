    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center mb-2 mb-md-0">
            ...
            <h5 class="mb-0 text-dark">
                Total de Registros: <span class="text-primary">{{ $accidents->count() }}</span>
            </h5>
        </div>

<!-- Filtro por Fecha de Registro -->
<div class="card shadow-sm p-3 mb-4 bg-white rounded border-0">
    <form method="GET" action="{{ route('sstsena.funcionario.accidents.index') }}" class="row g-3 align-items-end">
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <a href="{{ route('sstsena.funcionario.accidents.index') }}" class="btn btn-secondary ms-2">
...
<div class="modal fade" id="agregarPersonaModal" tabindex="-1" aria-labelledby="agregarPersonaModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" style="margin-top: 60px; max-width: 800px;"> <!-- tamaño reducido -->
