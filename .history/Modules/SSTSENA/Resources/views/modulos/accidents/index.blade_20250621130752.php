...
<div class="card shadow-sm p-3 mb-4 bg-white rounded border-0">
    <div class="d-flex flex-wrap justify-content-between align-items-center">
       <!-- Contador de registros al estilo profesional -->
<div class="col-md-6 d-flex align-items-center justify-content-center mb-3 mb-md-0">
    <div class="text-center">
        <div class="fs-1 fw-bold text-dark">{{ $accidents->count() }}</div>
        <div class="text-uppercase text-secondary fw-semibold" style="font-size: 0.85rem; letter-spacing: 1px;">Registros</div>
    </div>
</div>
