...
<div class="container mt-5">
    ...
    <a href="{{ route('sstsena.admin.unsafe_act_types.create') }}" class="btn btn-primary mb-4" style="background-color: #1a3c6e; border-color: #1a3c6e;">Crear Tipo de Actos Inseguros</a>
