...
<div class="container mt-5">
    ...
    <a href="{{ route('sstsena.admin.emergency_type.create') }}" class="btn btn-primary mb-4" style="background-color: #1a3c6e; border-color: #1a3c6e;">Crear Tipo de Emergencia</a>
