                            ...
                            <table class="table table-hover mb-0 corporate-table">
                                <thead>
                                    <tr class="corporate-header-row">
                                        ...
                                        <th class="corporate-th {{ $section['route_prefix'] }}-th-extra" style="width: 8%;">
                                            <div class="th-content">
                                        ...
                                        @else
                                            <th class="corporate-th {{ $section['route_prefix'] }}-th-extra" style="width: 8%;">
                                                <div class="th-content">
                                                    ...
                                                    <span>Tipo de {{ $section['type_label'] }}</span>
                                                </div>
                                            </th>
                                        @endif
                                        <th class="corporate-th {{ $section['route_prefix'] }}-th-extra" style="width: 8%;">
                                        ...
                                        <th class="corporate-th" style="width: 30%;">
                                            <div class="th-content">
                                                ...
                                                <span>Descripción del {{ $section['type_label'] }}</span>
                                            </div>
                                        </th>
                                        <th class="corporate-th" style="width: 8%;">
                                            <div class="th-content">
                                ...
                                <tbody>
                                    @forelse ($section['items'] as $itemIndex => $item)
                                        <tr class="corporate-row">
                                            ...
                                            <td class="corporate-cell {{ $section['route_prefix'] }}-cell-extra" style="width: 8%;">
                                                    ...
                                                    <div class="type-info">
                                                        <span class="fw-semibold text-dark">
                                                            @if($section['title'] == 'Incidentes de Trabajo')
                                                                {{ $item->incidentType->name ?? 'N/A' }}
                                                            @elseif($section['title'] == 'Situaciones de Emergencia')
                                                                {{ $item->emergencyType->name ?? 'N/A' }}
                                                            @elseif($section['title'] == 'Comportamientos Inseguros')
                                            ...
                                            <td class="corporate-cell {{ $section['route_prefix'] }}-cell-extra" style="width: 8%;">
                                                <div class="type-info">
                                                    <span class="fw-semibold text-dark">
                                                        @if($section['title'] == 'Accidentes Laborales')
                                                            {{ $item->accidentType->name ?? 'N/A' }}
                                                        @elseif($section['title'] == 'Incidentes de Trabajo')
                                                            {{ $item->incidentType->name ?? 'N/A' }}
                                                        @elseif($section['title'] == 'Situaciones de Emergencia')
                                                            {{ $item->emergencyType->name ?? 'N/A' }}
                                                        @elseif($section['title'] == 'Comportamientos Inseguros')
                                            ...
                                            <td class="corporate-cell {{ $section['route_prefix'] }}-cell-extra align-middle" style="width: 8%;">
                                                <div class="evidence-container">
                                                    @if($item->evidence)
                                                        @php
                                                            ...
                                                            $evidenceAlt = "Evidencia del {{ strtolower($section['type_label']) }} #" . str_pad($item->id, 4, '0', STR_PAD_LEFT);
                                                        @endphp
                                                            ...
                                                            <div class="evidence-preview">
                                                                ...
                                                                <div class="evidence-actions mt-2">
                                                                    <a href="{{ asset('storage/evidences/' . $item->evidence) }}"
                                                                       ...
                                                                       download="{{ 'evidencia-{{ strtolower($section['type_label']) }}-' . str_pad($item->id, 4, '0', STR_PAD_LEFT) . '.' . $ext }}">
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered modal-xl">
                                                                    <div class="modal-content bg-white rounded-3 shadow">
                                                                        <div class="modal-header border-bottom-0">
                                                                            <h5 class="modal-title" textdark="">{{ $evidenceAlt }}</h5>
                                            ...
                                            <td colspan="12" class="text-center py-5">
                                                <div class="empty-state-corporate">
                                                    ...
                                                    <p class="text-muted mb-0 small">
                                                        Los nuevos registros se registrarán y mostrarán aquí automáticamente
                                                    </small>
                                                </div>
                                            </tr>
                                        </div>
...
:root {
    ...
    --corporate-secondary: #2f8f9f1;
    --corporate-accent: #6c757d;
    --corporate-border: #e9ecef9;
...
.corporate-card:hover {
    ...
    box-shadow: 0 12px 24px var(--shadow-corporate);
    border-color: #dee2e6;
}

/* Headers de sección de corporativa */
.section-header {
...
@media (max-width: 992px) {
    ...
    .incidents-th-extra,
    .incidents-cell-extra,
    .emergencies-th-extra,
    .emergencies-cell-extra,
    .unsafe_acts-th-extra,
    .unsafe_acts-cell-extra {
        display: none;
    }
}
