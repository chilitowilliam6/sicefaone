...
<td class="corporate-cell text-center align-middle">
    @if($item->evidence)
        ...
        @if($isImage)
            ...
            <div class="mt-1">
                <a href="{{ $evidencePath }}" download
                   class="btn btn-sm btn-outline-primary rounded-pill mt-1" title="Descargar evidencia">
        ...
        @else
            <a href="{{ $evidencePath }}" download class="btn btn-sm btn-outline-secondary rounded-pill mt-1" title="Descargar archivo">
                <i class="fas fa-download me-1"></i>Descargar
            </a>
        @endif
    @else
