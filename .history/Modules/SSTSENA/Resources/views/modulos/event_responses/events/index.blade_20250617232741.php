...
<div class="row g-4 mb-4">
    <div class="col-12 section-item">
        <div class="corporate-card border-0 shadow-sm">
          ...
          {{-- Filtro por fecha del incidente --}}
<div class="filter-container px-4 py-3 border-bottom">
    <form method="GET" action="{{ request()->url() }}" class="row g-3 align-items-end">
        <div class="col-md-3">
            <label for="fecha_hora" class="form-label small fw-semibold text-dark">Fecha del Incidente</label>
            <input type="date" name="fecha_hora" id="fecha_hora" class="form-control form-control-sm" value="{{ request()->input('fecha_hora') }}">
        </div>
        <div class="col-md-3">
            <button type="submit" class="btn btn-sm corporate-btn">
                <i class="fas fa-filter me-2"></i> Filtrar
            ...
            <div class="table-container">
                <div class="table-responsive">
                    <table class="table table-hover mb-0 corporate-table">
                        <thead>
                            <tr class="corporate-header-row">
                                <th class="corporate-th"><i class="fas fa-id-badge me-2"></i>ID</th> <!-- Nueva columna para ID -->
    ...
    <div class="col-12 section-item">
        <div class="corporate-card border-0 shadow-sm">
            ...
            <div class="section-header" style="border-left: 4px solid #4169E1;">
              ...
              {{-- Filtro por fecha de emergencia --}}
<div class="filter-container px-4 py-3 border-bottom">
    <form method="GET" action="{{ request()->url() }}" class="row g-3 align-items-end">
        <div class="col-md-3">
            <label for="date_time" class="form-label small fw-semibold text-dark">Fecha de la Emergencia</label>
            <input type="date" name="date_time" id="date_time" class="form-control form-control-sm" value="{{ request()->input('date_time') }}">
        </div>
        <div class="col-md-3">
            <button type="submit" class="btn btn-sm corporate-btn">
