                    ...
                    @else
                        <ul class="list-group list-group-flush">
                            @foreach ($section['items'] as $item)
                                <li class="list-group-item corporate-list-item mb-3" style="--card-accent: {{ $section['color'] }};">
                                    ...
                                    <div class="list-body">
                                        ...
                                        @if ($section['title'] == 'Accidentes Laborales')
                                            ...
                                            <div class="evidence-content mb-2">
                                                @if($item->evidence)
                                                    @php
                                    ...
                                    <div class="list-footer d-flex justify-content-between mt-2">
