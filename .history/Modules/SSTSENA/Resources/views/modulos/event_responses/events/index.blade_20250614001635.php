        ...
        @if($item->evidence)
            ...
            @if($isImage)
                <div class="evidence-preview">
                    ...
                    <div class="evidence-actions mt-1">
                        <a href="{{ asset('storage/evidences/' . $item->evidence) }}"
                           class="btn btn-sm corporate-btn btn-outline-secondary"
                ...
                <!-- Improved modal for image -->
                <div class="modal fade" id="{{ $modalId }}" tabindex="-1" 
                     aria-labelledby="{{ $modalId }}Label" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" style="max-width: 90vw;">
                        <div class="modal-content corporate-modal border-0 shadow-sm">
                            <div class="modal-header border-bottom">
                                <h2 class="modal-title h6" id="{{ $modalId }}Label">
                            ...
                            <div class="modal-footer border-top">
                                <a href="{{ asset('storage/evidences/' . $item->evidence) }}"
                                   class="btn btn-sm corporate-btn btn-outline-secondary me-2"
                                   download="{{ 'evidencia-accidente-' . str_pad($item->id, 4, '0', STR_PAD_LEFT) . '.' . $ext }}"
                                   aria-label="Descargar evidencia">
                                    <i class="fas fa-download me-1"></i>Descargar
                                </a>
                                <button type="button" class="btn btn-sm corporate-btn btn-outline-secondary" 
                                        data-bs-dismiss="modal"
            ...
            @endif
        @else
            <p class="text-muted mb-0 small">Sin evidencia</p>
        @endif
    </div>
</td>
<td class="corporate-cell accidents-cell-extra" style="width: 8%;">
...
<td class="text-center corporate-cell" style="width: 8%;">
    <a href="{{ route('sstsena.' . $section['route_prefix'] . '.responses.index', $item->id) }}"
       class="corporate-btn btn btn-sm btn-outline-secondary">
