...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12 col-md-6 col-lg-4">
            <div class="corporate-card border-0 shadow-sm p-3">
                <form id="dateFilterForm" action="{{ route('sstsena.dashboard') }}" method="GET" class="d-flex align-items-center">
                    <div class="me-3 flex-grow-1">
                        <label for="filter_date" class="form-label fw-semibold">Filtrar por Fecha</label>
                        <input type="date" 
                               id="filter_date" 
                               name="filter_date" 
                               class="form-control corporate-input" 
                               value="{{ request('filter_date') }}" 
                               aria-label="Seleccionar fecha para filtrar registros">
                    </div>
                    <div class="d-flex align-items-end">
                        <button type="submit" class="btn corporate-btn me-2" aria-label="Aplicar filtro de fecha">
                            <i class="fas fa-filter me-1"></i> Filtrar
                        </button>
                        @if (request('filter_date'))
                            <a href="{{ route('sstsena.dashboard') }}" 
...
<style>
/* Existing styles remain unchanged, adding modal-specific and filter-specific styles */
.corporate-modal {
    background: white;
    border-radius: 8px;
