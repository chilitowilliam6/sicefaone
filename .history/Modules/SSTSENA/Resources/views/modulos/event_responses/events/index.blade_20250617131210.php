...
<td class="corporate-cell text-center align-middle">
    @if($item->evidence)
        ...
        @if($isImage)
            ...
            <!-- Botón de descarga formal -->
            <div class="d-grid mt-2">
                <a href="{{ $evidencePath }}" download
                   class="btn btn-sm btn-outline-dark fw-semibold rounded-pill px-3 shadow-sm"
                   title="Descargar imagen">
                    <i class="fas fa-download me-2"></i>Descargar Evidencia
                </a>
            </div>
        ...
        @else
            <a href="{{ $evidencePath }}" download
               class="btn btn-sm btn-outline-dark fw-semibold rounded-pill px-3 shadow-sm mt-2"
