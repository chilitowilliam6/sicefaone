        ...
        <tbody>
            @forelse ($accidents as $accident)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('accidents.responses.index', $accident->id) }}" class="btn btn-sm btn-primary">Ver Respuestas</a>
                    </td>
                </tr>
            @empty
                <tr>
        ...
        <tbody>
            @forelse ($incidents as $incident)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('sstsenaincidents.responses.index', $incident->id) }}" class="btn btn-sm btn-primary">Ver Respuestas</a>
                    </td>
                </tr>
            @empty
                <tr>
        ...
        <tbody>
            @forelse ($unsafeActs as $unsafeAct)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('unsafe_acts.responses.index', $unsafeAct->id) }}" class="btn btn-sm btn-primary">Ver Respuestas</a>
                    </td>
                </tr>
            @empty
                <tr>
