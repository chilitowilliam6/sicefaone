...
<div class="container-fluid py-4">
    {{-- Navigation Menu --}}
    <nav class="corporate-nav mb-4">
        <ul class="nav nav-pills justify-content-center">
            @foreach ($sections as $section)
                <li class="nav-item">
                    <a class="nav-link corporate-nav-link" href="#section-{{ Str::slug($section['title']) }}"
    ...
    <div class="row g-4">
        @foreach ($sections as $index => $section)
            <div class="col-12 section-item" id="section-{{ Str::slug($section['title']) }}">
                {{-- Card corporativa --}}
