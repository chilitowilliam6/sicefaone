...
<div class="container-fluid py-4">
    ...
    <div class="evidence-content">
        @if($item->evidence)
            ...
            @if($isImage)
                <!-- Miniatura de la imagen que abre el modal -->
                <a href="#" class="evidence-thumbnail" data-bs-toggle="modal" data-bs-target="#{{ $modalId }}">
                    <img src="{{ asset('storage/evidences/' . $item->evidence) }}"
                         alt="Evidencia"
                         class="img-thumbnail evidence-thumb"
                         loading="lazy">
                </a>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Evidencia visual</h5>
