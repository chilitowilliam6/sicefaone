                    ...
                    <table class="table table-hover mb-0 corporate-table">
                        <thead>
                            <tr class="corporate-header-row">
                                ...
                                <th class="corporate-th"><i class="fas fa-map-marker-alt me-2"></i>Ambiente</th>
                                <th class="corporate-th"><i class="fas fa-exclamation-triangle me-2"></i>Tipo de Riesgo</th>
                                <th class="corporate-th"><i class="fas fa-user-times me-2"></i>Acto inseguro</th>
...
<div class="row g-4">
                    ...
                    <table class="table table-hover mb-0 corporate-table">
                        <thead>
                            <tr class="corporate-header-row">
                                ...
                                <th class="corporate-th"><i class="fas fa-map-marker-alt me-2"></i>Ambiente</th>
                                <th class="corporate-th"><i class="fas fa-exclamation-triangle me-2"></i>Tipo de Riesgo</th>
                                <th class="corporate-th"><i class="fas fa-user-times me-2"></i>Tipo de Comportamiento</th>
                                <th class="corporate-th"><i class="fas fa-file-alt me-2"></i>Descripción</th>
                                <th class="corporate-th"><i class="fas fa-thermometer-half me-2"></i>Gravedad</th>
                                <th class="corporate-th"><i class="fas fa-camera me-2"></i>Evidencia</th>
                                <th class="corporate-th"><i class="fas fa-user me-2"></i>Creado por</th>
    ...
    @if($item->evidence)
        @php
            ...
            $evidencePath = asset('storage/evidence/' . $item->evidence);
        @endphp
...
</div> ponlo para que me salgan las imagenes en el campo evidence segun mi controlador  if ($request->hasFile('evidence')) {
