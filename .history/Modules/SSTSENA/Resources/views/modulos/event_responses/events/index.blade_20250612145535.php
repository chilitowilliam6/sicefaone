...
<div class="container-fluid py-4">
    ...
    <div class="evidence-content">
        @if($item->evidence)
            ...
            @if($isImage)
                <!-- Botón/miniatura para abrir modal -->
                <a href="#" class="d-inline-block" data-bs-toggle="modal" data-bs-target="#{{ $modalId }}">
            ...
            @else
                <a href="{{ $evidencePath }}" class="btn btn-sm btn-primary" target="_blank">
                    Ver archivo
                </a>
            @endif
        @else
