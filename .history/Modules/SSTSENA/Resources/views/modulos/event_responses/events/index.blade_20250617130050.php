                    ...
                    <table class="table table-hover mb-0 corporate-table">
                        <thead>
                            <tr class="corporate-header-row">
                                ...
                                <th class="corporate-th"><i class="fas fa-file-alt me-2"></i>Descripción</th>
                            ...
                            @forelse ($incidents as $item)
                                <tr class="corporate-row">
                                    ...
                                    <td class="corporate-cell">
                                        @switch($item->severity)
                                            @case('minor')
                                                <span class="severity-badge severity-low"><div class="severity-indicator"></div><span>Leve</span></span> @break
                                            @case('moderate')
                                                <span class="severity-badge severity-medium"><div class="severity-indicator"></div><span>Moderada</span></span> @break
                                            @case('serious')
                                                <span class="severity-badge severity-high"><div class="severity-indicator"></div><span>Grave</span></span> @break
                                            @case('fatal')
                                                <span class="severity-badge severity-critical"><div class="severity-indicator"></div><span>Fatal</span></span> @break
                                            @default
                                                <span class="severity-badge severity-pending"><div class="severity-indicator"></div><span>En Revisión</span></span>
                                        @endswitch
                                    </td>
                                    {{-- Evidencia como imagen con modal --}}
                                    <td class="corporate-cell text-center">
                                        @if($item->evidence && Str::startsWith($item->evidence, ['http', 'storage/', '/storage']))
                                            <img src="{{ asset($item->evidence) }}" alt="Evidencia" class="img-thumbnail" style="max-width: 60px; cursor: pointer;" data-bs-toggle="modal" data-bs-target="#modal-evidence-{{ $item->id }}">
                                            
                                            <!-- Modal -->
                                            <div class="modal fade" id="modal-evidence-{{ $item->id }}" tabindex="-1" aria-labelledby="evidenceModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Evidencia del Incidente</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                                        </div>
                                                        <div class="modal-body text-center">
                                                            <img src="{{ asset($item->evidence) }}" class="img-fluid rounded">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <td class="text-center corporate-cell">
                                        <a href="{{ route('sstsena.incidents.responses.index', $item->id) }}" class="corporate-btn">
                                            <i class="fas fa-folder-open me-2"></i><span>Revisar Caso</span>
                                        </a>
                                    </td>
                                </tr>
                            @empty
                ...
                <div class="table-container">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0 corporate-table">
                            ...
                            <tbody>
                                @forelse ($emergencies as $itemIndex => $item)
                                    <tr class="corporate-row">
                                        <td class="corporate-cell">
                                            <div class="reference-id">
                                                <span class="fw-bold" style="color: #4169E1;">
                                                    #{{ str_pad($item->id, 4, '0', STR_PAD_LEFT) }}
                                                </span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-5">
                                            <div class="empty-state-corporate">
                                                ...
                                                <h6 class="text-muted mb-2 fw-normal">No se encontraron registros de situaciones de emergencia</h6>
                                                <p class="text-muted mb-0 small">
                                                    Los nuevos incidentes se registrarán y mostrarán aquí automáticamente
                                                </p>
                                            </div>
