        ...
        <div class="corporate-card border-0 shadow-sm">
            ...
            <div class="filter-container px-4 py-3 border-bottom">
                <form method="GET" action="{{ request()->url() }}" class="row g-3 align-items-end">
                    <div class="col-md-3">
                        <label for="created_at" class="form-label small fw-semibold text-dark">Fecha de Creación</label>
                        <input type="date" name="created_at" id="created_at" class="form-control form-control-sm" value="{{ request()->input('created_at') }}">
                    </div>
                    <div class="col-md-3">
