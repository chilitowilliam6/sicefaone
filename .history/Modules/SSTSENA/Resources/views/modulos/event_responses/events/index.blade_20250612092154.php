        ...
        <div class="col-12">
            <div class="corporate-header border-0 shadow-sm">
                <div class="header-content text-center py-5 px-4">
                    ...
                    <h1 class="mb-2 fw-light">Sistema de Gestión de Seguridad y Salud en el Trabajo</h1>
                    <p class="mb-0 fs-5 opacity-75">Plataforma Empresarial para la Gestión de Seguridad y Riesgos</p>
                </div>
            </div>
        </div>
    </div>
