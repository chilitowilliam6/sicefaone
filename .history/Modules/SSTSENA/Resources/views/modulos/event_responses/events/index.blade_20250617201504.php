                            ...
                            <tbody>
                                @forelse ($emergencies as $item)
                                    <tr class="corporate-row">
                                        ...
                                        {{-- Tipo de Emergencia --}}
                                        <td class="corporate-cell">
                                            <span class="fw-semibold text-dark">{{ $item->emergencyType->name ?? 'N/A' }}</span>
                                        </td>
                                        ...
                                        <td class="corporate-cell" style="width: 8%;">
                                            <div class="created-by-info">
                                                <span class="fw-semibold text-dark">{{ $item->createdBy->nickname ?? 'Funcionario' }}</span>
                                                @if($item->createdBy)
                                                    <small class="text-muted d-block">{{ $item->createdBy->email ?? '' }}</small>
                                                @endif
                                            </div>
                                        </td>
                                    ...
                                    <tr class="corporate-row">
                                        ...
                                        <td class="corporate-cell">
                                            <div class="evidence-content">
                                                <p class="mb-0 text-dark lh-sm expandable-text" id="evidence-emergencies-{{ $item->id }}"
                                                   style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                    {{ $item->evidence ?? 'Sin evidencia disponible' }}
                                                </p>
                                                @if(strlen($item->evidence ?? '') > 65)
                                                    <small class="text-muted mt-1 d-block toggle-text" onclick="toggleText('evidence-emergencies-{{ $item->id }}')">
                                                        <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                        <span class="toggle-label">Mostrar más</span>
                                                    </small>
                                                @endif
