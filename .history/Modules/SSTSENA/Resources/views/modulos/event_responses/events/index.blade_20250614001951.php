            ...
            @if($isImage)
                ...
                <div class="modal fade" id="{{ $modalId }}" tabindex="-1" 
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 90vw;">
                        <div class="modal-content corporate-modal shadow-lg" style="border-radius: 8px; overflow: hidden;">
                            <div class="modal-header border-0 pb-2 px-3">
                            ...
                            <div class="modal-body p-3 d-flex justify-content-center align-items-center" style="background-color: #f8f9fa;">
                                <img src="{{ asset('storage/evidences/' . $item->evidence) }}"
                                     alt="{{ $evidenceAlt }}"
                                     class="img-fluid"
                                     style="max-height: 65vh; width: auto; object-fit: contain; border-radius: 4px;"
                                     loading="lazy">
                            </div>
                            <div class="modal-footer border-0 pt-2 px-3">
                                <a href="{{ asset('storage/evidences/' . $item->evidence) }}"
