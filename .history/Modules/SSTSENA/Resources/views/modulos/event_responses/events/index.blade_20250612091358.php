...
<div class="container-fluid py-4">
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="corporate-header border-0 shadow-sm">
                <div class="header-content text-center py-5 px-4">
                    <div class="header-icon mb-3">
                        <i class="fas fa-shield-check fa-3x"></i>
                    </div>
                    <h1 class="mb-2 fw-light">Occupational Health & Safety Management System</h1>
                    <p class="mb-0 fs-5 opacity-75">Enterprise-Grade Safety & Risk Management Platform</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="section-content d-flex justify-content-between align-items-center py-4 px-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Risk Assessment & Management</small>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover mb-0 corporate-table">
                                ...
                                <tbody>
                                    @forelse ($section['items'] as $itemIndex => $item)
                                        <tr class="corporate-row" style="animation-delay: {{ $itemIndex * 0.05 }}s;">
                                            <td class="corporate-cell">
                                                <div class="reference-id">
                                                   <tr class="corporate-row" style="animation-delay: {{ (float) $itemIndex * 0.05 }}s;">
                                            ...
                                            <td class="corporate-cell">
                                                <div class="datetime-info">
                                                    <div class="fw-semibold text-dark">{{ $item->date_time->format('M d, Y') }}</div>
                                            ...
                                            <td class="corporate-cell">
                                                <div class="description-content">
                                                    <p class="mb-0 text-dark lh-sm">{{ Str::limit($item->description ?? 'No description available', 65) }}</p>
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-center py-5">
                                                <div class="empty-state-corporate">
                                                    ...
                                                    <h6 class="text-muted mb-2 fw-normal">No {{ strtolower($section['title']) }} Records Found</h6>
                                                    <p class="text-muted mb-0 small">
                                                        New incidents will be automatically tracked and displayed here
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
