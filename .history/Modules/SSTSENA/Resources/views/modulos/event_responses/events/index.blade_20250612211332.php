...
@section('styles')
<style>
/* Existing styles remain unchanged, updating modal-specific and card alignment styles */
.corporate-modal {
    background: white;
    border-radius: 8px;
...
.cards-container .row {
    display: flex;
    justify-content: flex-end; /* Aligns cards to the right */
}

/* Optional: Adjust card width to prevent stretching */
.cards-container .col {
    flex: 0 0 auto; /* Ensures cards maintain their size */
}
...
@media (max-width: 576px) {
    ...
    /* On smaller screens, revert to full-width cards */
    .cards-container .row {
        justify-content: center; /* Center cards on small screens for better UX */
    }
}
</style>
@endsection
