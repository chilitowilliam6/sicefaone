    ...
    @php
        $sections = [
            [
                ...
                'color' => '#DC143C',
                'type_field' => 'accidentType',
                'type_label' => 'Tipo de Accidente',
            ],
            [
            ...
            [
                ...
                'icon' => 'fa-shield-alt',
                'color' => '#4169E1',
                'type_field' => 'emergencyType',
                'type_label' => 'Tipo de Emergencia',
            ],
            [
                ...
                'icon' => 'fa-eye-slash',
                'color' => '#708090',
                'type_field' => 'unsafeActType',
                'type_label' => 'Tipo de Comportamiento',
            ],
        ];
    @endphp
                                    ...
                                    <tr class="corporate-header-row">
                                        ...
                                        <th class="corporate-th" style="width: 30%;">
                                            <div class="th-content">
                                                ...
                                                <span>Descripción del {{ $section['title'] }}</span>
                                            </div>
                                        </th>
                                        <th class="corporate-th" style="width: 8%;">
                                            <div class="th-content">
                                        ...
                                        <tr class="corporate-row">
                                            ...
                                            <td class="corporate-cell accidents-cell-extra" style="width: 8%;">
                                                <div class="accident-type-info">
                                                    <span class="fw-semibold text-dark">{{ $item->{$section['type_field']}->name ?? 'N/A' }}</span>
                                                </div>
                                            </td>
                                                ...
                                                <div class="evidence-container">
                                                    @if($item->evidence)
                                                        @php
                                                            ...
                                                            $modalId = 'evidenceModal' . $item->id . '-' . $section['route_prefix'];
                                                            $evidenceAlt = "Evidencia del {{ strtolower($section['title']) }} #" . str_pad($item->id, 4, '0', STR_PAD_LEFT);
                                                        @endphp
                                                            ...
                                                            <div class="evidence-preview">
                                                                ...
                                                                <div class="evidence-actions mt-2">
                                                                    <a href="{{ asset('storage/evidences/' . $item->evidence) }}"
                                                                       ...
                                                                       download="{{ 'evidencia-' . $section['route_prefix'] . '-' . str_pad($item->id, 4, '0', STR_PAD_LEFT) . '.' . $ext }}">
