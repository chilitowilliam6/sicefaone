...
function showEvidenceModal(itemId, imageSrc) {
    const modalImage = document.getElementById('evidenceImage');
    modalImage.src = imageSrc; // Set the image source
    modalImage.onerror = () => {
        modalImage.src = ''; // Clear src on error to avoid broken image icon
        modalImage.alt = 'Error al cargar la evidencia';
    };
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    evidenceModal.addEventListener('hidden.bs.modal', function () {
        ...
        document.getElementById('evidenceImage').alt = 'Evidencia';
    });
});
</script>
@endsection