                    ...
                    <table class="table table-hover mb-0 corporate-table">
                        <thead>
                            <tr class="corporate-header-row">
                                ...
                                <th class="corporate-th"><i class="fas fa-briefcase-medical me-2"></i>Tipo de Lesión</th>
                                <th class="corporate-th"><i class="fas fa-exclamation-triangle me-2"></i>Tipo de Riesgo</th>
                                <th class="corporate-th"><i class="fas fa-briefcase me-2"></i>Tipo de Accidente</th>
                        ...
                        <tbody>
                            @forelse ($incidents as $item)
                                <tr class="corporate-row">
                                    ...
                                    {{-- Evidencia --}}
                                    <td class="corporate-cell">
                                        <p class="mb-0 text-dark lh-sm expandable-text" id="evidence-incidents-{{ $item->id }}"
                                           style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                            {{ $item->evidence ?? 'Sin evidencia disponible' }}
                                        </p>
                                        @if(strlen($item->evidence ?? '') > 65)
                                            <small class="text-muted mt-1 d-block toggle-text" onclick="toggleText('evidence-incidents-{{ $item->id }}')">
                                                <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                <span class="toggle-label">Mostrar más</span>
                                            </small>
                                        @endif
