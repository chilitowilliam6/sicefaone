...
<div class="container-fluid py-4">
    ...
    <div class="description-content">
        ...
        @if(strlen($item->description ?? '') > 65)
            <small class="text-muted mt-1 d-block" data-bs-toggle="modal" data-bs-target="#modalDescription{{ $item->id }}">
                <i class="fas fa-external-link-alt me-1"></i>Ver detalles completos
            </small>

            <!-- Modal para descripción completa -->
            <div class="modal fade" id="modalDescription{{ $item->id }}" tabindex="-1" aria-labelledby="modalDescriptionLabel{{ $item->id }}" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalDescriptionLabel{{ $item->id }}">Descripción completa</h5>
