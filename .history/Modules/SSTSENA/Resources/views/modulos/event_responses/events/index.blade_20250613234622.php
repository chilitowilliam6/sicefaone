...
<div class="container-fluid py-4">
        ...
        document.querySelectorAll('.toggle-text').forEach(function (toggle) {
            toggle.addEventListener('click', function () {
                ...
                if (fullText.classList.contains('d-none')) {
                    ...
                    this.innerHTML = '<i class="fas fa-compress me-1"></i>Mostrar menos';
                } else {
                    fullText.classList.add('d-none');
                    shortText.classList.remove('d-none');
                    this.innerHTML = '<i class="fas fa-external-link-alt me-1"></i>Ver detalles completos';
                }
            });
        });
    });
    ...
    $isLong = strlen($description) > 65;
@endphp

<td class="corporate-cell">
    <div class="description-content">
        <p class="mb-0 text-dark lh-sm">
            <span class="short-text">{{ Str::limit($description, 65) }}</span>
            @if ($isLong)
                <span class="full-text d-none">{{ $description }}</span>
                <small class="text-primary d-block mt-1 toggle-text" style="cursor: pointer;">
                    <i class="fas fa-external-link-alt me-1"></i>Ver detalles completos
                </small>
            @endif
        </p>
