                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0 corporate-table">
                                @if ($section['title'] == 'Accidentes Laborales')
                                    {{-- Table for Accidentes Laborales --}}
                                    <thead>
                                            ...
                                            <tr class="corporate-row">
                                                ...
                                                <td class="corporate-cell accidents-cell-extra">
                                                    <div class="created-at-info">
                                                        <span class="fw-semibold text-dark">{{ $item->created_at->format('d M Y H:i') ?? 'N/A' }}</span>
                                                    </div>
                                                </td>
                                                <td class="corporate-cell accidents-cell-extra">
                                                    <div class="updated-at-info">
                                                        <span class="fw-semibold text-dark">{{ $item->updated_at->format('d M Y H:i') ?? 'N/A' }}</span>
                                                    </div>
                                                </td>
                                                <td class="corporate-cell">
