        ...
        <tbody>
            @forelse ($accidents as $accident)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('cefa.accidents.responses.index', $accident->id) }}" class="btn btn-sm btn-primary">Ver Respuestas</a>
                    </td>
                </tr>
            @empty
                <tr>
        ...
        <tbody>
            @forelse ($incidents as $incident)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('cefa.incidents.responses.index', $incident->id) }}" class="btn btn-sm btn-primary">Ver Respuestas</a>
                    </td>
                </tr>
            @empty
                <tr>
        ...
        <tbody>
            @forelse ($emergencies as $emergency)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('cefa.emergencies.responses.index', $emergency->id) }}" class="btn btn-sm btn-primary">Ver Respuestas</a>
                    </td>
                </tr>
            @empty
                <tr>
        ...
        <tbody>
            @forelse ($unsafeActs as $unsafeAct)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('cefa.unsafe_acts.responses.index', $unsafeAct->id) }}" class="btn btn-sm btn-primary">Ver Respuestas</a>
                    </td>
                </tr>
            @empty
                <tr>
