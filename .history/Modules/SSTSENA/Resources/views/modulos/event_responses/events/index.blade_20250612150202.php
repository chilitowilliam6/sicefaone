                                                        ...
                                                        @if($item->evidence)
                                                            ...
                                                            @if($isImage)
                                                                ...
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#{{ $modalId }}">
                                                                    <img src="{{ asset('storage/emails/' . $item->evidence) }}"
                                                                         alt="Evidencia"
                                                                         class="img-thumbnail"
                                                                         style="inline-size: 48px; block-size: 48px; object-fit: cover;">
                                                                </a>
                                                            ...
                                                            @else
                                                                ...
                                                                <a href="{{ asset('storage/emails/' . $item->evidence) }}"
