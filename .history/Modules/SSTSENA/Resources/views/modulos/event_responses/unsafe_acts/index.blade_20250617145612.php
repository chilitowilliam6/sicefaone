...
<div class="container mt-5">
    <h1>Respuestas para Acto Inseguro Nº{{ $event->id }}</h1>
    ...
    <a href="{{ route('sstsena.unsafe_acts.responses.create', $event->id) }}" class="btn btn-primary mb-3">Agregar Respuesta</a>

    <table class="table table-bordered">
        <thead>
            <tr>
                <th>ID</th>@extends('sstsena::layouts.master')
                ...
                <div class="section-header" style="border-left: 4px solid #FF8C00;">
                    <div class="section-content d-flex justify-content-between align-items-center py-4 px-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-1 fw-semibold text-dark">Respuestas para Acto Inseguro Nº{{ $event->id }}</h4>
                ...
                <div class="px-4 py-3">
                    <div class="d-flex align-items-end mb-3 gap-3 justify-content-between">
                        <div class="d-flex align-items-end gap-3">
                            ...
                            <a href="{{ route('sstsena.unsafe_acts.responses.index', $event->id) }}" class="corporate-btn" style="border: 2px solid #adb5bd;">
                                <i class="fas fa-times me-2"></i>
                                <span>Limpiar Filtro</span>
                            </a>
                            <a href="{{ route('sstsena.unsafe_acts.responses.create', $event->id) }}"
                               class="corporate-btn" style="border: 2px solid #adb5bd;">
                                <i class="fas fa-plus me-2"></i>
                                <span>Agregar Respuesta</span>
                            </a>
                        </div>
                        <a href="{{ route('unsafe_acts.index') }}"
                           class="corporate-btn corporate>", corporate-btn-delete" style="border-color: #dc3545;">
                            <i class="fas fa-arrow-left me-2"></i>
                            <span>Volver</span>
                        </a>
                    </div>
                    <form id="dateFilterForm" method="GET" action="{{ route('sstsena.unsafe_acts.responses.index', $event->id) }}" class="d-none">
                        ...
                        <table class="table table-hover mb-0 corporate-table">
                            <thead>
                                <tr class="corporate-header-row">
                                    ...
                                    <th class="corporate-th midterm-ignore" style="width: 30%;">
                                        <div class="th-content">
                                    ...
                                    <th class="corporate-th text-center midterm-ignore" style="width: 15%;">
                                    ...
                                    <tr class="corporate-row">
                                        ...
                                        <td class="corporate-cell midterm-ignore">
                                            <div class="created-by-info">
                                                <span class="fw-semibold text-dark">{{ $response->createdBy->name ?? 'Funcionario' }}</span>
                                        ...
                                        <td class="text-center corporate-cell midterm-ignore">
                                            <div class="d-flex justify-content-center gap-2">
                                                <a href="{{ route('sstsena.unsafe_acts.responses.edit', [$event->id, $response->id]) }}"
                                                   class="corporate-btn corporate-btn-edit" style="border-color: #28a745;">
                                                    <i class="fas fa-edit"></i>
                                                    <span>Editar</span>
                                                </a>
                                                <form action="{{ route('sstsena.unsafe_acts.responses.destroy', [$event->id, $response->id]) }}"
        ...
        <tbody>
            @forelse ($responses as $response)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('sstsena.unsafe_acts.responses.edit', [$event->id, $response->id]) }}" class="btn btn-sm btn-warning">Editar</a>
                        <form action="{{ route('sstsena.unsafe_acts.responses.destroy', [$event->id, $response->id]) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
