    ...
    <div class="row g-4">
        <div class="col-12 section-item">
            ...
            <div class="corporate-card border-0 shadow-sm">
                ...
                {{-- Filtro por fecha --}}
                <div class="px-4 py-3">
                    <form method="GET" action="{{ route('sstsena.accidents.responses.index', $event->id) }}" class="d-flex align-items-center mb-3">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        forms.forEach(form => {
            form.addEventListener('submit', function(e) {
                // Solo aplicar a formularios que no tienen data-confirm
