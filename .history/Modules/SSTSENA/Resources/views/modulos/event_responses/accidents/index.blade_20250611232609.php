...
<div class="container mt-5">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            @endforelse
            @if(session('success'))
    <div class="position-fixed top-50 start-50 translate-middle bg-white border border-success shadow-lg rounded-4 text-center p-5 animate__animated animate__fadeInDown" style="z-index: 9999; width: 420px;">
        <div class="mb-3">
        ...
        <button onclick="this.parentElement.remove()" class="btn btn-success px-4 mt-3">Cerrar</button>
    </div>
@endif
