...
<div class="container-fluid py-4">
    ...
    if (auth()->user()->hasRole('admin')) {
        $ruta_editar = route('sstsena.admin.people_involved.edit', $people->id);
    } elseif (auth()->user()->hasRole('funcionario')) {
        $ruta_editar = route('sstsena.funcionario.people_involved.edit', $people->id);
    } else {
        $ruta_editar = '#'; // O una ruta por defecto o mensaje de error
    }
@endphp

<a href="{{ $ruta_editar }}" class="corporate-btn corporate-btn-edit" style="border-color: #28a745;">
    <i class="fas fa-edit"></i>
    <span>Editar</span>
</a>
