...
@if(session('success'))
<div class="position-fixed top-50 start-50 translate-middle alert alert-success text-center shadow z-50" role="alert" id="successAlert">
    {{ session('success') }}
</div>
<script>setTimeout(() => bootstrap.Alert.getOrCreateInstance(successAlert).close(), 5000);</script>
@endif
