...
<div class="container mt-5">
    ...
    <div class="alert alert-success alert-dismissible fade show position-fixed" 
         role="alert" 
         style="top: 20px; left: 50%; transform: translateX(-50%); z-index: 1050; min-width: 300px; max-width: 500px; background: #d4edda; border: 1px solid #c3e6cb; color: #155724; font: 1rem Arial, sans-serif; padding: 15px 20px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
        {{ session('success') }}
