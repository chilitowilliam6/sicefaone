            ...
            <div class="corporate-card border-0 shadow-sm">
                ...
                <div class="px-4 py-3">
                    <div class="d-flex align-items-center mb-3 gap-3">
                        <button type="submit" form="dateFilterForm" class="corporate-btn" style="border: 3px solid #007bff;">
                            <i class="fas fa-filter me-2"></i>
                            <span>Filtrar</span>
                        </button>
                        <a href="{{ route('sstsena.accidents.responses.index', $event->id) }}" class="corporate-btn" style="border: 3px solid #007bff;">
                            <i class="fas fa-times me-2"></i>
                            <span>Limpiar Filtro</span>
                        </a>
                        <a href="{{ route('sstsena.accidents.responses.create', $event->id) }}"
                           class="corporate-btn" style="border: 3px solid #007bff;">
                            <i class="fas fa-plus me-2"></i>
                            <span>Agregar Respuesta</span>
                        </a>
                    </div>
                    <form id="dateFilterForm" method="GET" action="{{ route('sstsena.accidents.responses.index', $event->id) }}" class="d-flex align-items-end mb-3 gap-3">
