...
@section('content')
@if(session('success'))
<div class="position-fixed top-50 start-50 translate-middle z-50">
    <div class="toast show text-white bg-success border-0" role="alert" data-bs-delay="5000" id="toastSuccess">
        <div class="d-flex">
