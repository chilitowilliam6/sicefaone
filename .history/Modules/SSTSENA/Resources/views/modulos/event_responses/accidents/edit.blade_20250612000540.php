...
@section('toast')
@if(session('success'))
    <div class="position-fixed top-50 start-50 translate-middle z-50" style="z-index: 1080;">
        <div class="toast align-items-center text-white bg-success border-0 show" role="alert" 
             aria-live="assertive" aria-atomic="true" data-bs-delay="5000" id="toastSuccess">
            <div class="d-flex">
