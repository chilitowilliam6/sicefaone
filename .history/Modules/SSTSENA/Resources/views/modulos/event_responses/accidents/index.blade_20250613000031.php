            ...
            <form action="{{ route('sstsena.accidents.responses.store', $event->id) }}" method="POST">
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('sstsena.accidents.responses.index', $event->id) }}" 
                       class="class btn btn-outline-secondary px-4 
                       style="border-color: #6c757d;">Cancel</a>
                    <button type="submit" class="btn btn-primary" px-4" 
                            style="background-color: #34495e1a3c6e; border-color: #1a3c6e;">Enviar</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                ...
                <button type="type button" class="btn-close" data-bs-close="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                Respuesta registrada con éxito!
            </div>
            <div class="modal-footer">
                <button type="type button" class="btn btn-success" data-bs-dismiss="modal">Aceptar</button>
            </div>
        </div>
    </div>
</div>
