...
<div class="container mt-5">
    ...
    <div class="alert alert-success alert-dismissible fade show position-fixed" 
         style="top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1050; min-width: 300px; max-width: 500px; background: #d4edda; border: 1px solid #c3e6cb; color: #155724; font: 1rem Arial; padding: 15px 20px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" 
         role="alert">
        {{ session('success') }}
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Cerrar"></button>
    </div>
    <script>setTimeout(() => { let a = document.querySelector('.alert-success'); if (a) { a.classList.remove('show'); a.classList.add('fade'); setTimeout(() => a.remove(), 150); } }, 10000);</script>
@endif
