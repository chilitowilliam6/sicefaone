    ...
    <div class="row g-4">
        <div class="col-12 section-item">
            ...
            <div class="corporate-card border-0 shadow-sm">
                ...
                {{-- Filtro por fecha y botones de acción --}}
                <div class="px-4 py-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <form method="GET" action="{{ route('sstsena.accidents.responses.index', $event->id) }}" class="d-flex align-items-center">
                        ...
                        <div>
                            <form id="bulk-delete-form" action="{{ route('sstsena.accidents.responses.bulkDestroy', $event->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" id="bulk-delete-btn" class="corporate-btn corporate-btn-delete" disabled>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Update "Select All" state and bulk delete button
    responseCheckboxes.forEach(checkbox => {
...
/* Print styles */
@media print {
    .corporate-btn, .response-checkbox, #select-all {
        display: none;
    }
