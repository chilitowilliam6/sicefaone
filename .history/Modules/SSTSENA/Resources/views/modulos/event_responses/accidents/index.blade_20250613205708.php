    ...
    <div class="row g-4">
        <div class="col-12 section-item">
            ...
            <div class="corporate-card border-0 shadow-sm">
                ...
                {{-- Filtro por fecha y botón de agregar --}}
                <div class="px-4 py-3 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        <form action="{{ route('sstsena.accidents.responses.index', $event->id) }}" method="GET" class="d-flex align-items-center">
                            <div class="me-3">
                                <label for="response_date_filter" class="form-label small text-muted mb-1">Filtrar por Fecha</label>
                                <input type="date" id="response_date_filter" name="response_date" class="form-control form-control-sm" style="max-width: 200px;" value="{{ request('response_date') }}">
                            </div>
                            <button type="submit" class="corporate-btn me-2">
                                <i class="fas fa-filter me-2"></i>
                                <span>Filtrar</span>
                            </button>
                            <a href="{{ route('sstsena.accidents.responses.index', $event->id) }}" class="corporate-btn">
                                <i class="fas fa-undo me-2"></i>
                                <span>Limpiar</span>
                            </a>
                        </form>
                    </div>
                    <a href="{{ route('sstsena.accidents.responses.create', $event->id) }}" class="corporate-btn">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Mostrar confirmación al enviar formularios
        const forms = document.querySelectorAll('form');
        
        forms.forEach(form => {
            form.addEventListener('submit', function(e) {
                // Solo aplicar a formularos que no tienen data-confirm
