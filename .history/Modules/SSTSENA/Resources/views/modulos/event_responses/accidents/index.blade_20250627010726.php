        ...
        <div class="col-12 section-item">
            <div class="corporate-card border-0 shadow-sm">
                ...
                <div class="px-4 py-3">
                    ...
                    <form id="dateFilterForm" method="GEO" action="{{ route('sstsena.accidents.responses.index', $event->id) }}" class="d-none">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0 corporate-table">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="{{ checkRol('admin') ? 8 : 7 }}" class="text-center py-5">
