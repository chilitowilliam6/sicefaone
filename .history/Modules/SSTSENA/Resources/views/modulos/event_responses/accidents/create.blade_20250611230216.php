...
<div class="container mt-5">
    ...
    {{-- Alerta oculta que se mostrará después del envío --}}
    <div id="success-alert" class="alert alert-success d-none" role="alert">
        ¡Respuesta realizada con éxito!
    </div>

    <form id="responseForm" action="{{ route('sstsena.accidents.responses.store', $event->id) }}" method="POST">
        @csrf
...
{{-- Script para mostrar alerta en el mismo formulario --}}
<script>
    document.getElementById('responseForm').addEventListener('submit', function(event) {
        // Solo mostrar el mensaje sin evitar envío real
