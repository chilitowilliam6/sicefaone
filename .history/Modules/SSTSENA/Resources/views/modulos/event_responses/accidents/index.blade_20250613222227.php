                ...
                <div class="px-4 py-3">
                    <form method="GET" action="{{ route('sstsena.accidents.responses.index', $event->id) }}" class="d-flex align-items-end mb-3 gap-3">
                        <div style="max-width: 180px;">
                            ...
                            <input type="date" name="date_filter" id="date_filter" class="form-control form-control-sm" style="border: 2.5px solid #000000;" value="{{ request('date_filter') }}">
                        </div>
                        <button type="submit" class="corporate-btn" style="border: 2.5px solid #000000;">
                            <i class="fas fa-filter me-2"></i>
                            <span>Filtrar</span>
                        </button>
                        <a href="{{ route('sstsena.accidents.responses.index', $event->id) }}" class="corporate-btn" style="border: 2.5px solid #000000;">
                    ...
                    <a href="{{ route('sstsena.accidents.responses.create', $event->id) }}"
                       class="corporate-btn" style="border: 2.5px solid #000000;">
