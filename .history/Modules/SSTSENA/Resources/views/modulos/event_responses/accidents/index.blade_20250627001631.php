    ...
    <div class="card shadow-sm rounded-3" style="background-color: #ffffff;">
        <div class="card-header" style="background-color: #f8f9fa; border-bottom: 1px solid #dee2e6;">
            <h3 class="text-center" style="color: #1a3c6e; font-weight: 600;">
                Agregar Respuesta a Emergencia Nº{{ $event->id }}
            </h3>
        </div>
        <div class="card-body p-4">
            <form action="{{ route('sstsena.emergencies.responses.store', $event->id) }}" method="POST">
                @csrf
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('sstsena.emergencies.responses.index', $event->id) }}" 
