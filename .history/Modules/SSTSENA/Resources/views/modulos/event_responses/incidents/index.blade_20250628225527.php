                ...
                <div class="section-header" style="border-left: 4px solid #FF8C00;">
                    <div class="section-content d-flex justify-content-between align-items-center py-4 px-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-1 fw-semibold text-dark">Respuestas para Emergencia Nº{{ $event->id }}</h4>
                ...
                <div class="px-4 py-3">
                    <div class="d-flex align-items-end mb-3 gap-3 justify-content-between">
                        <div class="d-flex align-items-end gap-3">
                            ...
                            <a href="{{ route('sstsena.emergencies.responses.index', $event->id) }}" class="corporate-btn" style="border: 2px solid #adb5bd;">
                                <i class="fas fa-times me-2"></i>
                                <span>Limpiar Filtro</span>
                            </a>
                            @if (!checkRol('sstsena.funcionario'))
                                <a href="{{ route('sstsena.emergencies.responses.create', $event->id) }}"
                    ...
                    <form id="dateFilterForm" method="GET" action="{{ route('sstsena.emergencies.responses.index', $event->id) }}" class="d-none">
                                        ...
                                        @if (checkRol('sstsena.admin'))
                                            <td class="text-center corporate-cell midterm-ignore">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="{{ route('sstsena.emergencies.responses.edit', [$event->id, $response->id]) }}"
                                                       class="corporate-btn corporate-btn-edit" style="border-color: #28a745;">
                                                        <i class="fas fa-edit"></i>
                                                        <span>Editar</span>
                                                    </a>
                                                    <form action="{{ route('sstsena.emergencies.responses.destroy', [$event->id, $response->id]) }}"
...
.modal-footer .corporate-btn {
    padding: Delete confirmation modal -->
    <div id="confirmDeleteModal" class="modal-confirm" style="display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Confirmar Eliminación</h3>
