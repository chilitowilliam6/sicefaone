                ...
                <div class="section-header" style="border-left: 4px solid #FF8C00;">
                    <div class="section-content d-flex justify-content-between align-items-center py-4 px-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-1 fw-semibold text-dark">Respuestas para Incidente Nº{{ $event->id }}</h4>
                ...
                <div class="px-4 py-3">
                    <div class="d-flex align-items-end mb-3 gap-3 justify-content-between">
                        <div class="d-flex align-items-end gap-3">
                            ...
                            <a href="{{ route('sstsena.incidents.responses.index', $event->id) }}" class="corporate-btn" style="border: 2px solid #adb5bd;">
                                <i class="fas fa-times me-2"></i>
                                <span>Limpiar Filtro</span>
                            </a>
                            <a href="{{ route('sstsena.incidents.responses.create', $event->id) }}"
                    ...
                    <form id="dateFilterForm" method="GET" action="{{ route('sstsena.incidents.responses.index', $event->id) }}" class="d-none">
                                    ...
                                    <tr class="corporate-row">
                                        ...
                                        <td class="corporate-cell midterm-ignore">
                                            <div class="environment-info">
                                                <span class="fw-semibold text-dark">{{ $event->environment->name ?? 'N/A' }}</span>
                                            </div>
                                        </td>
                                        <td class="corporate-cell midterm-ignore">
                                            <div class="risk-type-info">
                                                <span class="fw-semibold text-dark">{{ $event->riskType->name ?? 'N/A' }}</span>
                                            </div>
                                        </td>
                                        <td class="corporate-cell midterm-ignore">
                                            <div class="incident-type-info">
                                                <span class="fw-semibold text-dark">{{ $event->incidentType->name ?? 'N/A' }}</span>
                                            </div>
                                        </td>
                                        <td class="corporate-cell midterm-ignore">
                                            <div class="description-content">
                                                ...
                                                @if(strlen($response->response ?? '') > 65)
                                                    <small class="text-muted mt-1 d-block toggle-text" onclick="toggleText('response-{{ $response->id }}$1'>">
                                        ...
                                        <td class="corporate-cell midterm-ignore">
                                            <div class="created-by-info">
                                                <span class="fw-semibold text-dark">{{ $response->createdBy->nickname ?? 'Funcionario' }}</span>
                                        ...
                                        <td class="text-center corporate-cell midterm-ignore">
                                            <div class="d-flex justify-content-center gap-2">
                                                <a href="{{ route('sstsena.incidents.responses.edit', [$event->id, $response->id]) }}"
                                                   class="corporate-btn corporate-btn-edit" style="border-color: #28a745;">
                                                    <i class="fas fa-edit"></i>
                                                    <span>Editar</span>
                                                </a>
                                                <form action="{{ route('sstsena.incidents.responses.destroy', [$event->id, $response->id]) }}"
