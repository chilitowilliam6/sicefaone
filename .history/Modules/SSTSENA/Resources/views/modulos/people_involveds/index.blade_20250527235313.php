        ...
        <div class="card shadow-sm rounded-3" style="background-color: #ffffff;">
            ...
            <div class="card-body p-4">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach($peopleInvolved as $peopleInvolved)
                            <tr>
                                ...
                                <td>{{ $peopleInvolved->gender}}</td>
                                <td>{{ $peopleInvolved->personType->name }}</td>
                                <td>{{ $peopleInvolved->phone }}</td>
                                <td>{{ $peopleInvolved->address }}</td>
                                <td>
