...
<div class="container mt-5">
    <div class="card shadow-sm rounded-3" style="background-color: #ffffff;">
        ...
        <div class="card-body p-4">
              @if(checkRol('sstsena.funcionario.people_involved.update'))
           <form action="{{ route('sstsena.funcionario.people_involved.update', $peopleInvolved->id) }}" method="POST">
          @elseif(checkRol('sstsena.accidents.admin.edit'))
           <form action="{{ route('sstsena.accidents.admin.update', [$event->id, $response->id]) }}" method="POST">
