...
<div class="container mt-5">
    <div class="card shadow-sm rounded-3" style="background-color: #ffffff;">
        ...
        <div class="card-body p-4">
            <form action="{{ route('sstsena.funcionario.people_involveds.update', $peopleInvolved->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" class="form-control border-light-subtle" rows="4">{{ $peopleInvolved->description }}</textarea>
                </div>
