...
<div class="corporate-card shadow-sm mb-4">
    ...
    <div class="px-4 py-3">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
            ...
            <form method="GET" action="{{ route('sstsena.funcionario.people_involved.index') }}" class="d-flex align-items-center gap-2 w-100">
                <a href="{{ route('sstsena.funcionario.people_involved.create') }}" class="corporate-btn" style="border-color: #28a745; background: #d4edda; color: #155724;">
        ...
        <table class="table table-hover mb-0 corporate-table">
            <thead>
                <tr class="corporate-header-row">
                    ...
                    <th class="corporate-th">T.D</th>
                    <th class="corporate-th">Nº Documento</th>
