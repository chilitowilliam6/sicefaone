    ...
    function updateChart() {
        ...
        chart = new Chart(document.getElementById('eventsChart'), {
            ...
            data: {
                ...
                datasets: [
                    { label: 'Accidentes', data: accidents, backgroundColor: colors.accidents, borderRadius: 10, borderWidth: 2 },
                    { label: 'Incidentes', data: incidents, backgroundColor: colors.incidents, borderRadius: 10, borderWidth: 2 },
                    { label: 'Emergencias', data: emergencies, backgroundColor: colors.emergencies, borderRadius: 10, borderWidth: 2 },
                    { label: 'Actos Inseguros', data: unsafeActs, backgroundColor: colors.unsafeActs, borderRadius: 10, borderWidth: 2 }
                ]
            },
            options: {
                responsive: true,
                ...
                barPercentage: 0.8, // Aquí aumente a 0.8 para barras más gruesas
                categoryPercentage: 0.9 // También aumenté para mayor tamaño
            }
        });
    }
