...
<script>
    ...
    function processDataByYear(data, year) {
        const counts = {
            accidents: 0,
            incidents: 0,
            emergencies: 0,
    ...
    function updateChart() {
        ...
        const { accidents, incidents, emergencies, unsafeActs } = processDataByYear(rawData, year);
        ...
        chart = new Chart(document.getElementById('eventsChart'), {
            ...
            data: {
                ...
                datasets: [{
                    data: [accidents, incidents, emergencies, unsafeActs],
                    backgroundColor: [colors.accidents, colors.incidents, colors.emergencies, colors.unsafeActs],
                    borderColor: '#ffffff',
                    borderWidth: 2
                }]
            },
