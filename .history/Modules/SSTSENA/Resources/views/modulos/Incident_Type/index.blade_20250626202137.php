...
<div class="container mt-5">
    ...
    <a href="{{ route('sstsena.admin.incident_types.create') }}" class="btn btn-primary mb-4" style="background-color: #1a3c6e; border-color: #1a3c6e;">Registrar Tipo de Accidente</a>
