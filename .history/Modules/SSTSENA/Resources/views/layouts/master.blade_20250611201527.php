                    ...
                    <div class="accordion" id="menuAccordion">
                        ...
                        <div class="accordion-item border-0 bg-transparent">
                            ...
                            <div id="actosinsegurosCollapse" class="accordion-collapse collapse"
                                ...
                                data-bs-parent="#menuAccordion">
                                <div class="accordion-body p-0">
                                    <a href="{{ route('cefa.accidents.responses.index', ['eventType' => 'accidente', 'eventId' => $evento->id]) }}" class="nav-link ps-4">
                                        <i class="far fa-circle me-2"></i>Tipo Actos Inseguros
                                    </a>
                                    <a href="{{ route('event_responses.create') }}" class="nav-link ps-4">
                                        <i class="far fa-circle me-2"></i>Crear Tipo
                                    </a>
                                </div>
