...
<nav class="navbar navbar-expand fixed-top bg-light shadow-sm">
    <div class="container-fluid">
        ...
        <!-- Título centrado: Gestión SST -->
        <div class="mx-auto d-flex align-items-">
            <i class="fas fa-hard-hat text-warning me-43"></i>
            <span class="fw-bold text-dark">Gestión SST</span>
        </div>
