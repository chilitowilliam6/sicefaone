...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <aside class="main-sidebar sidebar-success-green elevation-4">
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex border-bottom">
                <div class="image">
                    <img src="{{ asset('AdminLTE-3.2.0/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2" alt="User Image" loading="lazy">
                </div>
                <div class="info">
    ...
    <!-- Footer -->
    <footer class="main-footer bg-dark text-white text-center p-3">
