  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
    ...
    @auth
                            @if (checkRol('gpes.admin'))
                                <li>
                                    <a class="nav-link @if (Route::is('gpes.admin.*')) active @endif"
                                        href="{{ route('gpes.admin.welcome') }}">
                                        Administrador
                                    </a>
                                </li>
                            @endif
                            @if (checkRol('gpes.apprentice'))
                                <li>
                                    <a class="nav-link @if (Route::is('gpes.apprentice.*')) active @endif"
                                        href="{{ route('gpes.apprentice.panel') }}">
                                        Aprendiz
                                    </a>
                                </li>
                            @endif
                            @if (checkRol('gpes.instructor'))
                                <li>
                                    <a class="nav-link @if (Route::is('gpes.instructor.*')) active @endif"
                                        href="{{ route('gpes.instructor.panel') }}">
                                        Instructor
                                    </a>
                                </li>
                            @endif
                            @if (checkRol('gpes.pasante'))
                                <li>
                                    <a class="nav-link @if (Route::is('gpes.pasante.*')) active @endif"
                                        href="{{ route('gpes.pasante.panel') }}">
                                        Pasante
                                    </a>
                                </li>
                            @endif
