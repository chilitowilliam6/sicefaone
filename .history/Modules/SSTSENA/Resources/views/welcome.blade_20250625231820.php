...
<nav id="menu" class="hidden md:flex flex-col md:flex-row md:items-center gap-6 text-base font-semibold text-gray-700 bg-white md:bg-transparent shadow-lg md:shadow-none py-4 px-6 md:p-0 rounded-lg md:rounded-none absolute md:static top-20 right-4 transition-all duration-300 ease-in-out">
    ...
    @auth
        ...
        @if (checkRol('sstsena.admin'))
            <li class="list-none">
                <a class="relative px-3 py-2 hover:text-orange-600 transition-colors duration-200 ease-in-out hover:after:absolute hover:after:bottom-0 hover:after:left-0 hover:after:w-full hover:after:h-0.5 hover:after:bg-orange-600" 
                   href="{{ route('sstsena.admin.welcome') }}">
                   Administrador
                </a> 
            </li>
        @endif
        ...
        @if (checkRol('sstsena.funcionario'))
            <li class="list-none">
                <a class="relative px-3 py-2 hover:text-orange-600 transition-colors duration-200 ease-in-out hover:after:absolute hover:after:bottom-0 hover:after:left-0 hover:after:w-full hover:after:h-0.5 hover:after:bg-orange-600" 
                   href="{{ route('sstsena.funcionario.welcome') }}">
                   Funcionario
                </a> 
            </li>
        @endif
    ...
    @guest
        {{-- Solo mostrar "Ver más" si no está logueado --}}
        <li class="list-none">
            <a class="relative px-3 py-2 hover:text-orange-600 transition-colors duration-200 ease-in-out hover:after:absolute hover:after:bottom-0 hover:after:left-0 hover:after:w-full hover:after:h-0.5 hover:after:bg-orange-600" 
               href="{{ route('login') }}">
               Ver más
