...
class AccidentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Accident::create([
            'date_time' => $validate->date_time,
            'environment_id' => $validate->environment_id,
            'injury_type_id' => $validate->injury_type_id,
            'risk_type_id' => $validate->risk_type_id,
            'accident_type_id' => $validate->accident_type_id,
            'description' => $validate->description,
            'evidence' => $validate->file('evidence')->store('evidence', 'public'),
            'severity' => $validate->severity,
        ]);
        return redirect()->route('sstsena.admin.accidents.index')->with('success', 'Accident created successfully.');
    }
