...
class PeopleInvolvedController extends Controller
{
    ...
    public function index()
    {
        ...
        $accidente = Accident::all();
        return view('sstsena::modulos.people_involved.index', compact('peopleInvolved', 'typePersons', 'accidente'));
    }
    ...
    public function create()
    {
        $typePersons = TypePerson::all();
        $accidente = Accident::all();
        return view('sstsena::modulos.people_involveds.create', compact('typePersons', 'accidente'));
    }
