...
class AccidentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sstsena::modulos.accidents.index', compact('Accidents', 'environmets', 'injuryTypes', 'riskTypes', 'accidentTypes'));
    }
    ...
    public function create()
    {
        ...
        $riskTypes = RiskType::all();
        $accidentTypes = AccidentType::all();
        return view('sstsena::modulos.accidents.index', compact('environmets', 'injuryTypes', 'riskTypes', 'accidentTypes') );
    }
