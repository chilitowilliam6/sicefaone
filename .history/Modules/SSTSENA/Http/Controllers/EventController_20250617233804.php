...
public function index()
{
    ...
    // Aplica el filtro de fecha para todas las tablas si está presente
    if (request()->has('date_time') && !empty(request()->input('date_time'))) {
        ...
        $incidentsQuery->whereDate('date_time', $dateTime);
        $emergenciesQuery->whereDate('date_time', $dateTime);
        $unsafeActsQuery->whereDate('date_time', $dateTime);
    }
