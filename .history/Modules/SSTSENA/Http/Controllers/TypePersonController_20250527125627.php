...
class TypePersonController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sstsena::modulos.person_types.index' compact('risktype'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sstsena:modulos.person_types.index')->with('success', 'Type person created successfully.');
    }
