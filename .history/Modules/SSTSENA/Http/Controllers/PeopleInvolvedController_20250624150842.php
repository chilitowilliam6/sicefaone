...
class PeopleInvolvedController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        //condicional que pregunte el rol//
        if (checkRol('sstsena.funcionario')) {
            return redirect()->route('sstsena.funcionario.people_involved.index')->with('success', 'Person involved updated successfully.');
        } elseif (checkRol('sstsena.admin')) {
            return redirect()->route('sstsena.admin.modulos.event_responses.accidents.index')->with('success', 'Person involved updated successfully.');
        }
    }
