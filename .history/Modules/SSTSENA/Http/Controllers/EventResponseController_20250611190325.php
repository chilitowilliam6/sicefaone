...
class EventResponseController extends Controller
{
     ...
     public function index($eventType, $eventId)
    {
        ...
        return view('sstsena::modulos.event_responses.index', compact('event', 'responses', 'eventType'));
    }
    ...
    public function create($eventType, $eventId)
    {
        ...
        return view('sstsena::modulos.event_responses.create', compact('event', 'eventType'));
    }
    ...
    public function edit($eventType, $eventId, $id)
    {
        ...
        return view('<sstsena::modulos class=""></sstsena::modulos>event_responses.edit', compact('event', 'response', 'eventType'));
    }
