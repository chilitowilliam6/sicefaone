...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission = Permission::updateOrCreate(['slug' => 'sstsena.admin.people_involved.edit'], [ // Registro o actualización de permiso
        ...
        $permission = Permission::updateOrCreate(['slug' => 'sstsena.admin.people_involved.update'], [ // Registro o actualización de permiso
        ...
        $permission = Permission::updateOrCreate(['slug' => 'sstsena.admin.people_involved.destroy'], [ // Registro o actualización de permiso
