...
@section('content')
    <div class="container-fluid py-4">
        ...
        @if (session('success'))
            <div id="alertaExito" class="alert alert-success border-0 shadow-sm mx-auto mb-4 fade-in corporate-alert"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <button type="button" class="btn-close btn-close-sm"
                        onclick="document.getElementById('alertaExito')?.remove()"></button>
                </div>
            </div>

            <script>
                setTimeout(() => document.getElementById('alertaExito')?.classList.add('fade-out'), 5000);
            </script>
        @endif
        ...
        <div class="row g-4 mb-4">
                ...
                <div class="corporate-card border-0 shadow-sm">
                    ...
                    <div class="filter-container px-4 py-3 border-bottom">
                        <form method="GET" action="{{ request()->url() }}" class="row g-3 align-items-end">
                            <div class="col-md-3">
                                <label for="date_time_accidents" class="form-label small fw-semibold text-dark">Fecha del
                                    Accidente</label>
                                <input type="date" name="date_time_accidents" id="date_time_accidents"
                                    class="form-control form-control-sm"
                                    value="{{ request()->input('date_time_accidents') }}">
                            </div>
                            <div class="col-md-3">
                            ...
                            <table class="table table-hover mb-0 corporate-table">
                                <thead>
                                    <tr class="corporate-header-row">
                                        ...
                                        <th class="corporate-th text-center">Personas</th>
                                        ...
                                        <tr class="corporate-row">
                                            ...
                                            <td class="corporate-cell" style="width: 8%;">
                                                <div class="datetime-info">
                                                    <div class="fw-semibold text-dark">
                                                        {{ $item->date_time->format('d M Y') }}</div>
                                                    <small class="text-muted">
                                                        <i
                                                            class="fas fa-clock me-1"></i>{{ $item->date_time->format('H:i') }}
                                                    </small>
                                                </div>
                                            </td>
                                            ...
                                            <td class="corporate-cell accidents-cell-extra" style="width: 8%;">
                                                <div class="risk-type-info">
                                                    <span
                                                        class="fw-semibold text-dark">{{ $item->riskType->name ?? 'N/A' }}</span>
                                                </div>
                                            </td>
                                            <td class="corporate-cell accidents-cell-extra" style="width: 8%;">
                                                <div class="accident-type-info">
                                                    <span
                                                        class="fw-semibold text-dark">{{ $item->accidentType->name ?? 'N/A' }}</span>
                                                </div>
                                            </td>
                                            <td class="corporate-cell" style="width: 30%;">
                                                <div class="description-content">
                                                    <p class="mb-0 text-dark lh-sm expandable-text"
                                                        id="description-accidents-{{ $item->id }}"
                                                        style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                        {{ $item->description ?? 'Sin descripción disponible' }}
                                                    </p>
                                                    @if (strlen($item->description ?? '') > 65)
                                                        <small class="text-muted mt-1 d-block toggle-text"
                                                            onclick="toggleText('description-accidents-{{ $item->id }}')">
                                            ...
                                            <td class="corporate-cell accidents-cell-extra align-middle"
                                                ...
                                                @if ($item->evidence)
                                                    @php
                                                        $ext = strtolower(
                                                            pathinfo($item->evidence, PATHINFO_EXTENSION),
                                                        );
                                                    ...
                                                    @else
                                                        <a href="{{ $evidencePath }}" class="btn btn-sm corporate-btn"
                                            ...
                                            <td class="corporate-cell accidents-cell-extra" style="width: 8%;">
                                                <div class="creado-por-info">
                                                    <span
                                                        class="fw-semibold text-dark">{{ $item->user->person->first_name ?? 'Funcionario' }}</span>
                                                    @if ($item->user)
                                                        <small
                                                            class="text-muted d-block">{{ $item->user->email ?? '' }}</small>
                                                    @endif
                                                </div>
                                            </td>
                                            <td class="corporate-cell text-center">
                                                <button class="corporate-btn"
                                                    style="border-color: #17a2b8; background-color: #d1ecf1; color: #0c5460;"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#personasModal{{ $item->id }}">
                                            ...
                                            <td class="text-center corporate-cell" style="width: 8%;">
                                                <div class="response-indicator">
                                                    <span
                                                        class="response-count">{{ $item->eventResponses->count() }}</span>
                                                ...
                                                <td colspan="12" class="text-center py-5">
                                                    <div class="empty-state-corporate">
                                                        <div class="empty-icon mb-3">
                                                            <i
                                                                class="fas fa-exclamation-triangle fa-3x text-muted opacity-25"></i>
                                                        </div>
                                                        <h6 class="text-muted mb-2 fw-normal">No se encontraron registros de
                                                            accidentes laborales</h6>
                                                        <p class="text-muted mb-0 small">
                                                            Los nuevos incidentes se registrarán y mostrarán aquí
                                                            automáticamente
                                                        </p>
                                                    </div>
                                                </td>
            ...
            @foreach ($accidents as $accident)
                @if ($accident->accidentPersons->count())
                    <div class="modal fade" id="personasModal{{ $accident->id }}" tabindex="-1"
                        aria-labelledby="personasModalLabel{{ $accident->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header bg-info text-white">
                                    <h5 class="modal-title" id="personasModalLabel{{ $accident->id }}">Personas Involucradas
                                        -
                                        Accidente #{{ $accident->id }}</h5>
                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                        aria-label="Cerrar"></button>
                                </div>
                                <div class="modal-body">
                                    @foreach ($accident->accidentPersons as $personaAcc)
                                        @php
                                            $info = $personaAcc->person->getTipoPersonaYCargo();
                                        @endphp
                                        <div class="border rounded p-3 mb-3 bg-light">
                                            <p><strong>Nombre:</strong>
                                                {{ $personaAcc->person->full_name ?? $personaAcc->person->name }}</p>
                                            <p><strong>Cargo:</strong> {{ $info['cargo'] }}</p>
                                            <p><strong>Documento:</strong> {{ $personaAcc->person->document_number }}</p>
                                            <p><strong>Tipo de Lesión:</strong> {{ $personaAcc->injuryType->name ?? 'N/A' }}
                                            </p>
                                            <p><strong>Observación:</strong>
                                                {{ $personaAcc->observation ?: 'Sin observaciones' }}
                                            </p>
                                        </div>
                                    @endforeach
                                </div>
                ...
                <div class="col-12 section-item">
                    <div class="corporate-card border-0 shadow-sm">
                        ...
                        <div class="filter-container px-4 py-3 border-bottom">
                            <form method="GET" action="{{ request()->url() }}" class="row g-3 align-items-end">
                                <div class="col-md-3">
                                    <label for="date_time_incidents" class="form-label small fw-semibold text-dark">Fecha del
                                        Incidente</label>
                                    <input type="date" name="date_time_incidents" id="date_time_incidents"
                                        class="form-control form-control-sm"
                                        value="{{ request()->input('date_time_incidents') }}">
                                </div>
                                <div class="col-md-3">
                                    <button type="submit" class="btn btn-sm corporate-btn">
                                        <i class="fas fa-filter me-2"></i> Filtrar
                                ...
                                <table class="table table-hover mb-0 corporate-table">
                                    <thead>
                                        <tr class="corporate-header-row">
                                            ...
                                            <th class="corporate-th"><i class="fas fa-exclamation-triangle me-2"></i>Tipo de
                                                Riesgo</th>
                                            <th class="corporate-th"><i class="fas fa-briefcase me-2"></i>Tipo de incidente
                                            </th>
                                            <th class="corporate-th"><i class="fas fa-file-alt me-2"></i>Descripción del
                                                Incidente</th>
                                            ...
                                            <th class="corporate-th text-center"><i
                                                    class="fas fa-comments me-2"></i>Respuestas</th>
                                            <th class="corporate-th text-center"><i class="fas fa-tools me-2"></i>Acciones
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @forelse ($incidents as $item)
                                            <tr class="corporate-row">
                                                ...
                                                <td class="corporate-cell">
                                                    <div class="fw-semibold text-dark">{{ $item->date_time->format('d M Y') }}
                                                    </div>
                                                    <small class="text-muted"><i
                                                            class="fas fa-clock me-1"></i>{{ $item->date_time->format('H:i') }}</small>
                                                </td>
                                                <td class="corporate-cell">
                                                    <span
                                                        class="fw-semibold text-dark">{{ $item->environment->name ?? 'N/A' }}</span>
                                                ...
                                                <td class="corporate-cell">
                                                    <span
                                                        class="fw-semibold text-dark">{{ $item->incidentType->name ?? 'N/A' }}</span>
                                                </td>
                                                <td class="corporate-cell">
                                                    <p class="mb-0 text-dark lh-sm expandable-text"
                                                        id="description-incidents-{{ $item->id }}"
                                                        style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                        {{ $item->description ?? 'Sin descripción disponible' }}
                                                    </p>
                                                    @if (strlen($item->description ?? '') > 65)
                                                        <small class="text-muted mt-1 d-block toggle-text"
                                                            onclick="toggleText('description-incidents-{{ $item->id }}')">
                                                            <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                            <span class="toggle-label">Mostrar más</span>
                                                        </small>
                                                    @endif
                                                ...
                                                <td class="corporate-cell text-center align-middle">
                                                    @if ($item->evidence)
                                                        @php
                                                            ...
                                                            $isImage = in_array($ext, $imageExtensions);
                                                            $evidencePath = asset(
                                                                'storage/evidences/' . $item->evidence,
                                                            );
                                                        @endphp
                                                        @if ($isImage)
                                                            <button type="button" class="btn p-0 border-0 bg-transparent"
                                                ...
                                                <td class="text-center corporate-cell">
                                                    <a href="{{ route('sstsena.incidents.responses.index', $item->id) }}"
                                                        class="corporate-btn">
                                                        <i class="fas fa-folder-open me-2"></i>
                                                        <span>Revisar Caso</span>
                                                    </a>
                                                ...
                                                <tr>
                                                    <td colspan="11" class="text-center py-5">
                                                        <div class="empty-state-corporate">
                                                            ...
                                                            <h6 class="text-muted mb-2 fw-normal">No se encontraron registros de
                                                                incidentes de trabajo</h6>
                                                            <p class="text-muted mb-0 small">Los nuevos incidentes se registrarán y
                                                                mostrarán aquí automáticamente</p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforelse
                    ...
                    <div class="col-12 section-item">
                        <div class="corporate-card border-0 shadow-sm">
                            ...
                            <div class="filter-container px-4 py-3 border-bottom">
                                <form method="GET" action="{{ request()->url() }}" class="row g-3 align-items-end">
                                    <div class="col-md-3">
                                        <label for="date_time_emergencies" class="form-label small fw-semibold text-dark">Fecha de
                                            la Emergencia</label>
                                        <input type="date" name="date_time_emergencies" id="date_time_emergencies"
                                            class="form-control form-control-sm"
                                            value="{{ request()->input('date_time_emergencies') }}">
                                    </div>
                                    <div class="col-md-3">
                                        <button type="submit" class="btn btn-sm corporate-btn">
                                            <i class="fas fa-filter me-2"></i> Filtrar
                                    ...
                                    <table class="table table-hover mb-0 corporate-table">
                                        <thead>
                                            <tr class="corporate-header-row">
                                                ...
                                                <th class="corporate-th"><i class="fas fa-exclamation-triangle me-2"></i>Tipo de
                                                    Riesgo</th>
                                                <th class="corporate-th"><i class="fas fa-bullhorn me-2"></i>Tipo de Emergencia
                                                </th>
                                                <th class="corporate-th"><i class="fas fa-file-alt me-2"></i>Descripción de
                                                    emergencia</th>
                                                <th class="corporate-th"><i class="fas fa-thermometer-half me-2"></i>Gravedad</th>
                                                <th class="corporate-th"><i class="fas fa-camera me-2"></i>Evidencia</th>
                                                <th class="corporate-th"><i class="fas fa-user me-2"></i>Creado por</th>
                                        ...
                                        <tbody>
                                            @forelse ($emergencies as $item)
                                                <tr class="corporate-row">
                                                    ...
                                                    <td class="corporate-cell">
                                                        <p class="mb-0 text-dark lh-sm expandable-text"
                                                            id="environment-emergencies-{{ $item->id }}"
                                                            style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                            {{ $item->environment->name ?? 'N/A' }}
                                                        </p>
                                                        @if (strlen($item->environment->name ?? '') > 65)
                                                            <small class="text-muted mt-1 d-block toggle-text"
                                                                onclick="toggleText('environment-emergencies-{{ $item->id }}')">
                                                                <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                                <span class="toggle-label">Mostrar más</span>
                                                            </small>
                                                        @endif
                                                    ...
                                                    <td class="corporate-cell">
                                                        <p class="mb-0 text-dark lh-sm expandable-text"
                                                            id="riskType-emergencies-{{ $item->id }}"
                                                            style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                            {{ $item->riskType->name ?? 'N/A' }}
                                                        </p>
                                                        @if (strlen($item->riskType->name ?? '') > 65)
                                                            <small class="text-muted mt-1 d-block toggle-text"
                                                                onclick="toggleText('riskType-emergencies-{{ $item->id }}')">
                                                                <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                                <span class="toggle-label">Mostrar más</span>
                                                            </small>
                                                        @endif
                                                    ...
                                                    <td class="corporate-cell">
                                                        <p class="mb-0 text-dark lh-sm expandable-text"
                                                            id="emergencyType-emergencies-{{ $item->id }}"
                                                            style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                            {{ $item->emergencyType->name ?? 'N/A' }}
                                                        </p>
                                                        @if (strlen($item->emergencyType->name ?? '') > 65)
                                                            <small class="text-muted mt-1 d-block toggle-text"
                                                                onclick="toggleText('emergencyType-emergencies-{{ $item->id }}')">
                                                                <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                                <span class="toggle-label">Mostrar más</span>
                                                            </small>
                                                        @endif
                                                    ...
                                                    <td class="corporate-cell">
                                                        <p class="mb-0 text-dark lh-sm expandable-text"
                                                            id="description-emergencies-{{ $item->id }}"
                                                            style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                            {{ $item->description ?? 'Sin descripción disponible' }}
                                                        </p>
                                                        @if (strlen($item->description ?? '') > 65)
                                                            <small class="text-muted mt-1 d-block toggle-text"
                                                                onclick="toggleText('description-emergencies-{{ $item->id }}')">
                                                                <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                                <span class="toggle-label">Mostrar más</span>
                                                            </small>
                                                        @endif
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('sstsena.emergencies.responses.index', $item->id) }}"
                                                            class="corporate-btn">
                                                    ...
                                                    <tr>
                                                        <td colspan="11" class="text-center py-5">
                                                            <div class="empty-state-corporate">
                                                                ...
                                                                <h6 class="text-muted mb-0 fw-normal">No se encontraron registros de
                                                                    situaciones de emergencia</h6>
                                                                <small class="text-muted">
                        ...
                        <div class="col-12 section-item">
                            <div class="corporate-card border-0 shadow-sm">
                                ...
                                <div class="filter-container px-4 py-3 border-bottom">
                                    <form method="GET" action="{{ request()->url() }}" class="row g-3 align-items-end">
                                        <div class="col-md-3">
                                            <label for="date_time_unsafe_acts" class="form-label small fw-semibold text-dark">Fecha
                                                del Acto Inseguro</label>
                                            <input type="date" name="date_time_unsafe_acts" id="date_time_unsafe_acts"
                                                class="form-control form-control-sm"
                                                value="{{ request()->input('date_time_unsafe_acts') }}">
                                        </div>
                                        <div class="col-md-3">
                                            <button type="submit" class="btn btn-sm corporate-btn">
                                                <i class="fas fa-filter me-2"></i> Filtrar
                                        ...
                                        <table class="table table-hover mb-0 corporate-table">
                                            <thead>
                                                <tr class="corporate-header-row">
                                                    ...
                                                    <th class="corporate-th"><i class="fas fa-exclamation-triangle me-2"></i>Tipo de
                                                        Riesgo</th>
                                                    <th class="corporate-th"><i class="fas fa-user-times me-2"></i>Tipo de acto
                                                        inseguro</th>
                                                    <th class="corporate-th"><i class="fas fa-file-alt me-2"></i>Descripción de
                                                        inseguridades</th>
                                                    <th class="corporate-th"><i class="fas fa-thermometer-half me-2"></i>Gravedad</th>
                                            ...
                                            <tbody>
                                                @forelse ($unsafeActs as $item)
                                                    <tr class="corporate-row">
                                                        ...
                                                        <td class="corporate-cell">
                                                            <p class="mb-0 text-dark lh-sm expandable-text"
                                                                id="environment-unsafe_acts-{{ $item->id }}"
                                                                style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                                {{ $item->environment->name ?? 'N/A' }}
                                                            </p>
                                                            @if (strlen($item->environment->name ?? '') > 65)
                                                                <small class="text-muted mt-1 d-block toggle-text"
                                                                    onclick="toggleText('environment-unsafe_acts-{{ $item->id }}')">
                                                                    <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                                    <span class="toggle-label">Mostrar más</span>
                                                                </small>
                                                            @endif
                                                        ...
                                                        <td class="corporate-cell">
                                                            <p class="mb-0 text-dark lh-sm expandable-text"
                                                                id="riskType-unsafe_acts-{{ $item->id }}"
                                                                style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                                {{ $item->riskType->name ?? 'N/A' }}
                                                            </p>
                                                            @if (strlen($item->riskType->name ?? '') > 65)
                                                                <small class="text-muted mt-1 d-block toggle-text"
                                                                    onclick="toggleText('riskType-unsafe_acts-{{ $item->id }}')">
                                                                    <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                                    <span class="toggle-label">Mostrar más</span>
                                                                </small>
                                                            @endif
                                                        ...
                                                        <td class="corporate-cell">
                                                            <p class="mb-0 text-dark lh-sm expandable-text"
                                                                id="unsafeActType-unsafe_acts-{{ $item->id }}"
                                                                style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                                {{ $item->unsafeActType->name ?? 'N/A' }}
                                                            </p>
                                                            @if (strlen($item->unsafeActType->name ?? '') > 65)
                                                                <small class="text-muted mt-1 d-block toggle-text"
                                                                    onclick="toggleText('unsafeActType-unsafe_acts-{{ $item->id }}')">
                                                                    <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                                    <span class="toggle-label">Mostrar más</span>
                                                                </small>
                                                            @endif
                                                        ...
                                                        <td class="corporate-cell">
                                                            <p class="mb-0 text-dark lh-sm expandable-text"
                                                                id="description-unsafe_acts-{{ $item->id }}"
                                                                style="max-height: 3em; overflow: hidden; transition: max-height 0.3s ease;">
                                                                {{ $item->description ?? 'Sin descripción disponible' }}
                                                            </p>
                                                            @if (strlen($item->description ?? '') > 65)
                                                                <small class="text-muted mt-1 d-block toggle-text"
                                                                    onclick="toggleText('description-unsafe_acts-{{ $item->id }}')">
                                                                    <i class="fas fa-chevron-down me-1 toggle-icon"></i>
                                                                    <span class="toggle-label">Mostrar más</span>
                                                                </small>
                                                            @endif
