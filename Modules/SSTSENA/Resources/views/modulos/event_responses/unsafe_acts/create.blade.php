    ...
    <div class="card shadow-sm rounded-3" style="background-color: #ffffff;">
        <div class="card-header" style="background-color: #f8f9fa; border-bottom: 1px solid #dee2e6;">
            <h3 class="text-center" style="color: #1a3c6e; font-weight: 600;">
                Agregar Respuesta a Acto Inseguro Nº{{ $event->id }}
            </h3>
        </div>
        <div class="card-body p-4">
            <form action="{{ route('sstsena.unsafe_acts.responses.store', $event->id) }}" method="POST">
                @csrf
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('sstsena.unsafe_acts.responses.index', $event->id) }}" 
