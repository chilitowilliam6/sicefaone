    ...
    <div class="corporate-card shadow-sm mb-4">
        ...
        <div class="px-4 py-3">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <!-- Filtro por Fecha -->
                <form method="GET" action="{{ route('sstsena.funcionario.accidents.index') }}"
                    ...
                    <a href="{{ route('sstsena.funcionario.accidents.index') }}" class="corporate-btn"
                        ...
                        <tr class="corporate-row">
                                    ...
                                    @if ($isImage)
                                        <button type="button" class="btn p-0 border-0 bg-transparent"
                                            ...
                                            <img src="{{ asset('storage/evidences/' . $accident->evidence) }}"
                                                alt="Evidencia" class="img-thumbnail"
                                                style="width: 60px; height: 60px; object-fit: cover;">
                                        </button>
                                    @else
                                        <a href="{{ asset('storage/evidences/' . $accident->evidence) }}"
                                            class="corporate-btn" target="_blank" style="border-color: #007bff;">Ver
                                            archivo</a>
                                    @endif
                                @else
                            ...
                            <td class="corporate-cell text-center">
                                <button class="corporate-btn"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#personasModal{{ $accident->id }}">
                            ...
                            <tr>
                                <td colspan="11" class="text-center py-5">
                                    <div class="empty-state-corporate">
                                        ...
                                        <p class="text-muted mb-0 small">Los nuevos registros aparecerán aquí automáticamente
                                        </p>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <div class="modal-body">
                                @foreach ($accident->accidentPersons as $personaAcc)
                                    ...
                                    <div class="border rounded p-3 mb-3 bg-light">
                                        ...
                                        <p><strong>Tipo de Lesión:</strong> {{ $personaAcc->injuryType->name ?? 'N/A' }}</p>
                                        <p><strong>Observación:</strong> {{ $personaAcc->observation ?: 'Sin observaciones' }}
                                        </p>
                                    </div>
                                @endforeach
                            </div>
