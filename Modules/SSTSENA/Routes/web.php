...
/* Route::get('/diagram', [EventController::class, 'indexDiagram'])->name('diagram.index'); */
...
Route::middleware(['lang'])->group(function () { // Middleware que permite la internacionalización
    ...
    Route::prefix('diagram')->group(function () {
        Route::get('/', [EventController::class, 'indexDiagram'])->name('sstsena.admin.diagram.index');
    });
    ...
    Route::prefix('accidents')->group(function () {
        ...
        Route::get('/buscarPorDocumento', [AccidentController::class, "buscarPorDocumento"])->name('sstsena.funcionario.accidents.buscarPorDocumento');
